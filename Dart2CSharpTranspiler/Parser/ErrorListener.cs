...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/error/listener.dart
...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     * engine.
     */
    public abstract class AnalysisErrorListener
    {
        /**
         * An error listener that ignores errors that are reported to it.
         */
        public static AnalysisErrorListener NULL_LISTENER = new _NullErrorListener();

        /**
         * This method is invoked when an [error] has been found by the analysis
         * engine.
         */
        public abstract void onError(AnalysisError error);
    }
     ...
     * reported to it.
     */
    public class BooleanErrorListener : AnalysisErrorListener
    {
        /**
         ...
         */
        public bool errorReported => _errorReported;
    ...
    public class ErrorReporter
    {
         ...
         */
        public readonly Source _defaultSource;
         ...
         */
        public ErrorReporter(AnalysisErrorListener _errorListener, Source _defaultSource)
        {
            ...
            {
                throw new ArgumentException("An error listener must be provided");
            }
            else if (_defaultSource == null)
            {
                throw new ArgumentException("A default source must be provided");
            }
         ...
         */
        public void reportErrorForElement(ErrorCode errorCode, Element element,
         ...
         */
        public void reportErrorForNode(ErrorCode errorCode, AstNode node,
            List<Object> arguments = null)
        {
         ...
         */
        public void reportErrorForOffset(ErrorCode errorCode, int offset, int length,
            List<Object> arguments = null)
        {
         ...
         */
        public void reportErrorForToken(ErrorCode errorCode, Token token,
            List<Object> arguments = null)
        {
         ...
         */
        public void reportTypeErrorForNode(
     ...
     */
    public class RecordingErrorListener : AnalysisErrorListener
    {
        /**
         * A map of sets containing the errors that were collected, keyed by each
         * source.
         */
        Dictionary<Source, HashSet<AnalysisError>> _errors =
      new Dictionary<Source, HashSet<AnalysisError>>();
     ...
     */
    class _NullErrorListener : AnalysisErrorListener
    {
        public override void onError(AnalysisError error)
        {
            // Ignore errors
