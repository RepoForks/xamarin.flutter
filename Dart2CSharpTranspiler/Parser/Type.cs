...
namespace Dart2CSharpTranspiler.Parser
{
    ...
    public class BottomTypeImpl : TypeImpl
    {
        ...
        // public         public bool isMoreSpecificThan(DartType type,
        bool withDynamic = false, HashSet<Element> visitedElements) =>
            true;

        public bool isSubtypeOf(DartType type) => true;

        public bool isSupertypeOf(DartType type) => false;
  ...
  DynamicTypeImpl._()
    ...
    public int get hashCode => 1;

  public bool get isDynamic => true;
...
[Obsolete]
public List<TypeParameterElement> get boundTypeParameters => typeFormals;
...
public FunctionTypedElement get element => super.element;

public int get hashCode {
        if (element == null)
        {
            return 0;
        }
...
int code = returnType.hashCode;
    ...
    public Dictionary<String, DartType> get namedParameterTypes {
...
List<FunctionTypeAliasElement> get newPrune;
    ...
    public List<DartType> get normalParameterTypes {
...
public List<DartType> get optionalParameterTypes {
    List<DartType> types = new List<DartType> { };
 ...
 */
public class InterfaceTypeImpl : TypeImpl implements InterfaceType
{
    /**
...
public List<PropertyAccessorElement> get accessors {
...
public List<ConstructorElement> get constructors {
    _flushCachedMembersIfStale();
...
public ClassElement get element => super.element;
...
public List<InterfaceType> get interfaces {
...
public bool get isDartAsyncFuture {
    ClassElement element = this.element;
    if (element == null)
    {
        return false;
...
public bool get isDartAsyncFutureOr {
    ClassElement element = this.element;
    if (element == null)
    {
        return false;
...
public bool get isDartCoreFunction {
    ClassElement element = this.element;
    if (element == null)
    {
        return false;
...
public bool get isDartCoreNull {
    ClassElement element = this.element;
    if (element == null)
    {
        return false;
...
public bool get isObject => element.supertype == null && !element.isMixin;

public List<MethodElement> get methods {
    _flushCachedMembersIfStale();
    if (_methods == null)
    {
...
public List<InterfaceType> get mixins {
    List<InterfaceType> mixins = element.mixins;
    return _instantiateSuperTypes(mixins);
}

public InterfaceType get superpublic class {
        ClassElement classElement = element;
...
public List<TypeParameterElement> get typeParameters => element.typeParameters;
 ...
 public abstract class TypeImpl : DartType
{
  ...
  bool _hasTypeParameterReferenceInBound;
    ...
    public String get displayName => name;

    public Element get element => _element;
    ...
    public bool get isBottom => false;

    public bool get isDartAsyncFuture => false;

    public bool get isDartAsyncFutureOr => false;

    public bool get isDartCoreFunction => false;

    public bool get isDartCoreNull => false;

    public bool get isDynamic => false;

    public bool get isObject => false;

    public bool get isUndefined => false;

    public bool get isVoid => false;
 ...
 */
public class TypeParameterTypeImpl : TypeImpl implements TypeParameterType
{
    ...
    public DartType get bound => element.bound ?? DynamicTypeImpl.instance;

    public ElementLocation get definition => element.location;

    public TypeParameterElement get element => super.element as TypeParameterElement;

    public int get hashCode => element.hashCode;
...
public class UndefinedTypeImpl : TypeImpl
{
  ...
  public bool get isUndefined => true;
 ...
 * The type `void`.
 */
abstract public class VoidType implements DartType
{
    public VoidType substitute2(
      List<DartType> argumentTypes, List<DartType> parameterTypes);
}
 ...
 */
public class VoidTypeImpl : TypeImpl implements VoidType
{
    /**
     * The unique instance of this class.
     */
  ...
  VoidTypeImpl._() : super(null, Keyword.VOID.lexeme);
    ...
    public int get hashCode => 2;

  public bool get isVoid => true;
...
public class _FunctionTypeImplLazy : FunctionTypeImpl
{
    ...
    public final List<FunctionTypeAliasElement> prunedTypedefs;
    ...
    public bool get isInstantiated => _isInstantiated;

    public List<FunctionTypeAliasElement> get newPrune {
        Element element = this.element;
    ...
    public List<String> get normalParameterNames {
    ...
    public List<String> get optionalParameterNames {
        return baseParameters
    ...
    public List<ParameterElement> get parameters {
...
TypeImpl type;
    ...
    public DartType get returnType
    {
    ...
    public List<TypeParameterElement> get typeFormals {
...
public List<TypeParameterElement> get typeParameters {
...
{
    public final DartType returnType;

    public final List<TypeParameterElement> typeFormals;

    public final List<ParameterElement> parameters;
    ...
    public bool get isInstantiated => throw new UnimplementedError('TODO(paulberry)');

    public List<FunctionTypeAliasElement> get newPrune => const {};

public List<String> get normalParameterNames =>

  parameters.where((p) => p.isNotOptional).map((p) => p.name).toList();

public List<String> get optionalParameterNames => parameters
  .where((p) => p.isOptionalPositional)
      .map((p) => p.name)
      .toList();

public List<FunctionTypeAliasElement> get prunedTypedefs => const { };

public List<DartType> get typeArguments => const { } /*TODO(paulberry)*/;

public List<TypeParameterElement> get typeParameters => const { } /*TODO(paulberry)*/;
