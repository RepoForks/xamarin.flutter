...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/src/dart/element/type.dart
...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     */
    //    public class BottomTypeImpl : TypeImpl
    //    {
    //        /**
    //         * The unique instance of this class.
    //         */
    //        public static BottomTypeImpl instance = new BottomTypeImpl._();

    //        /**
    //         * Prevent the creation of instances of this class.
    //         */
    //        BottomTypeImpl() : base(null, "<bottom>") { }

    //        public virtual int hashCode => 0;

    //        public virtual bool isBottom => true;
    ...
    //        public override bool isSubtypeOf(DartType type) => true;

    //        public override bool isSupertypeOf(DartType type) => false;
    ...
    //        public BottomTypeImpl substitute2(
    //                List<DartType> argumentTypes, List<DartType> parameterTypes,
    //                List<FunctionTypeAliasElement> prune = null) =>
    //            this;
    //    }
    ...
    //     * function type.
    //     */
    //    public class CircularFunctionTypeImpl : DynamicTypeImpl, _FunctionTypeImplLazy
    //    {
    //        public CircularFunctionTypeImpl() : base._circular() { }

    //        public List<ParameterElement> baseParameters => new List<ParameterElement> { };

    //        public DartType baseReturnType => DynamicTypeImpl.instance;
    ...
    //        public FunctionTypedElement element => null;


    //        public bool isInstantiated => false;

    //        Dictionary<String, DartType> namedParameterTypes => new Dictionary<String, DartType> { };

    //        public List<FunctionTypeAliasElement> newPrune =>
    //            new List<FunctionTypeAliasElement> { };

    //        public List<String> normalParameterNames => new List<String> { };

    //        public List<DartType> normalParameterTypes => new List<DartType> { };

    //        public List<String> optionalParameterNames => new List<String> { };


    //        public List<DartType> optionalParameterTypes => new List<DartType> { };

    //        public List<ParameterElement> parameters => new List<ParameterElement> { };

    //        public List<FunctionTypeAliasElement> prunedTypedefs =>
    //            new List<FunctionTypeAliasElement> { };


    //        public DartType returnType => DynamicTypeImpl.instance;
    //        public List<DartType> typeArguments => new List<DartType> { };

    //        public List<TypeParameterElement> typeFormals => new List<TypeParameterElement> { };


    //        public List<TypeParameterElement> typeParameters =>
    //            new List<TypeParameterElement> { };

    //        public bool _isInstantiated => false;

    //        public List<ParameterElement> _parameters => new List<ParameterElement> { };


    //        public DartType _returnType => DynamicTypeImpl.instance;


    //        public List<DartType> _typeArguments => new List<DartType> { };

    //        public void set_typeArguments(List<DartType> arguments)
    //        {
    //            throw new NotSupportedException("Cannot have type arguments");
    //        }

    //        public List<TypeParameterElement> _typeParameters =>
    //        new List<TypeParameterElement> { };


    //        public void set_typeParameters(List<TypeParameterElement> parameters)
    //        {
    //            throw new NotSupportedException("Cannot have type parameters");
    //        }
    ...
    //        public FunctionTypeImpl instantiate(List<DartType> argumentTypes) => this;

    //        public FunctionTypeImpl pruned(List<FunctionTypeAliasElement> prune) => this;

    //        public FunctionType substitute2(
    //            List<DartType> argumentTypes, List<DartType> parameterTypes,
    ...
    //        public FunctionTypeImpl substitute3(List<DartType> argumentTypes) => this;

    //        public void _forEachParameterType(
    ...
    //           FunctionType type, HashSet<TypeParameterType> free)
    //        {
    //            // There are no free variables
    //        }

    //        public void _freeVariablesInInterfaceType(
    //          InterfaceType type, HashSet<TypeParameterType> free)
    //        {
    //            // There are no free variables
    //        }

    //        void _freeVariablesInType(DartType type, HashSet<TypeParameterType> free)
    //        {
    //            // There are no free variables
    //        }
    //    }
    ...
    //     * `...`.
    //     */
    //    public class CircularTypeImpl : DynamicTypeImpl
    //    {
    //        public CircularTypeImpl() : base._circular() { }
    ...
    //     */
    //    public class DeferredFunctionTypeImpl : _FunctionTypeImplLazy
    //    {
    //        /**
    ...
    //        public DeferredFunctionTypeImpl(this._computeElement, String name,
    //          List<DartType> typeArguments, bool isInstantiated)
    //          : base(null, name, null, typeArguments, null, null, isInstantiated) { }

    //        public FunctionTypedElement element()
    //        {
    ...
    //     */
    //    public class DynamicTypeImpl : TypeImpl
    //    {
    //        /**
    //         * The unique instance of this class.
    //         */
    //        static readonly DynamicTypeImpl instance = new DynamicTypeImpl._();
    ...
    //    public //bool operator ==(Object object) => identical(object, this);
    ...
    // */
    //abstract public class FunctionTypeImpl : TypeImpl, FunctionType
    //{
    //    /**
    ...
    //        var typeVars = new List<DartType> { };
    //var freshTypeVars = new List<DartType> { };
    //var freshVarElements = new List<TypeParameterElement> { };
    ...
    //[Obsolete]
    //public List<TypeParameterElement> boundTypeParameters => typeFormals;
    ...
    //public FunctionTypedElement element => super.element;
    ...
    //{
    //    Dictionary<String, DartType> types = new List<String, DartType> { };
    ...
    // * this function type.
    // */
    //List<FunctionTypeAliasElement> newPrune;
    ...
    //            HashSet<TypeParameterType> freeVariables = new HashSet<TypeParameterType>();
    ...
    //                    // are sequential from there. Thus +0x2050 will us the subscript.
    ...
    //        List<DartType> normalParameterTypes = this.normalParameterTypes;
    //        List<DartType> optionalParameterTypes = this.optionalParameterTypes;
    //        Dictionary<String, DartType> namedParameterTypes = this.namedParameterTypes;
    ...
    //public abstract FunctionTypeImpl instantiate(List<DartType> argumentTypes);
    ...
    //public bool isEquivalentTo(DartType other)
    //{
    ...
    //public FunctionTypeImpl substitute3(List<DartType> argumentTypes) =>
    ...
    //    List<DartType> typeArgs = new List<DartType> { };
    ...
    //    var tRequired = new List<ParameterElement> { };
    //    var tOptional = new List<ParameterElement> { };
    //    var tNamed = new List<String, ParameterElement> { };
    ...
    //    var sRequired = new List<ParameterElement> { };
    //    var sOptional = new List<ParameterElement> { };
    //    var sNamed = new List<String, ParameterElement> { };
    ...
    // * (e.g. `<T : LowerBound>`) that satisfy [relation].
    // *
    ...
    // * `F` to `F -> F` and `F -> F`, which we can see are equal.
    // */
    ...
    // */
    //static bool _equals(
    //    Dictionary<String, DartType> firstTypes, Dictionary<String, DartType> secondTypes)
    //{
    ...
    // */
    //public class InterfaceTypeImpl : TypeImpl, InterfaceType
    //{
    //    /**
    //     * A list containing the actual types of the type arguments.
    //     */
    //    List<DartType> _typeArguments = new List<DartType> { };
    ...
    //     * to avoid creating infinite types in response to self-referential typedefs.
    //     */
    //    public readonly List<FunctionTypeAliasElement> prunedTypedefs;

    //    /**
    //     * The version of [element] for which members are cached.
    //     */
    //    int _versionOfCachedMembers = 0; // was null
    ...
    //      : base(element, element.displayName)
    //    { }
    ...
    //        base(null, name) { prunedTypedefs = null }
    ...
    //public ClassElement element => super.element;
    ...
    //public bool isObject => element.supertype == null && !element.isMixin;
    ...
    //public InterfaceType superpublic class {
    //        ClassElement classElement = element;
    ...
    //public List<TypeParameterElement> typeParameters => element.typeParameters;
    ...
    //public DartType flattenFutures(TypeSystem typeSystem)
    //{
    //    // Implement the cases:
    ...
    //public InterfaceTypeImpl instantiate(List<DartType> argumentTypes) =>
    //  substitute2(argumentTypes, typeArguments);

    //public bool isDirectSupertypeOf(InterfaceType type)
    //{
    ...
    //    }
    //    //
    //    // I is listed in the : clause of J.
    //    //
    ...
    //    {
    //        //
    //        // T is bottom. (This case is handled by the public class BottomTypeImpl.)
    //        //
    ...
    //public ConstructorElement lookUpConstructor(
    ...
    //public PropertyAccessorElement lookUpGetter(
    ...
    //public PropertyAccessorElement lookUpGetterInSuperclass(
    //    String getterName, LibraryElement library)
    //{
    ...
    //public PropertyAccessorElement lookUpInheritedGetter(String name,
    ...
    //    public ExecutableElement lookUpInheritedGetterOrMethod(String name,
    ...
    //public MethodElement lookUpInheritedMethod(String name,
    //      { LibraryElement library, bool thisType: true}) {
    ...
    //  public PropertyAccessorElement lookUpInheritedSetter(String name,
    //      { LibraryElement library, bool thisType: true}) {
    //    PropertyAccessorElement result;
    //    if (thisType) {
    ...
    //public MethodElement lookUpMethodInSuperclass(
    ...
    //public PropertyAccessorElement lookUpSetter(
    ...
    //public PropertyAccessorElement lookUpSetterInSuperclass(
    //    String setterName, LibraryElement library)
    //{
    //    for (InterfaceType mixin in mixins.reversed)
    //    {
    ...
    //public InterfaceTypeImpl pruned(List<FunctionTypeAliasElement> prune)
    //{
    //    if (prune == null)
    //    {
    //        return this;
    ...
    //public InterfaceTypeImpl substitute2(
    //    List<DartType> argumentTypes, List<DartType> parameterTypes,
    //    [List<FunctionTypeAliasElement> prune])
    //{
    ...
    //[Obsolete]
    //public InterfaceTypeImpl substitute4(List<DartType> argumentTypes) =>
    ...
    ///**
    // * Starting from this type, search its public class hierarchy for types of the form
    // * Future<R>, and return a list of the resulting R's.
    // */
    //List<DartType> _searchTypeHierarchyForFutureTypeParameters()
    //{
    //    List<DartType> result = new List<DartType> { };
    //    HashSet<ClassElement> visitedClasses = new HashSet<ClassElement>();
    ...
    //        {
    //            if (type.superpublic class != null)
    //            {
    ...
    //      { [Obsolete] bool strong = true}) {
    //    // compute set of supertypes
    //    HashSet<InterfaceType> si = computeSuperinterfaceSet(i);
    //HashSet<InterfaceType> sj = computeSuperinterfaceSet(j);
    ...
    // * See [computeLeastUpperBound].
    // */
    //static HashSet<InterfaceType> computeSuperinterfaceSet(InterfaceType type,
    //          { [Obsolete] bool strong = true}) =>
    ...
    //    List<DartType> bucket = new List<DartType> { };
    ...
    //   */
    //  static HashSet<InterfaceType> _computeSuperinterfaceSet(
    ...
    //    HashSet<InterfaceType> first, HashSet<InterfaceType> second)
    //{
    //    HashSet<InterfaceType> result = new HashSet<InterfaceType>.from(first);
    ...
    //    {
    //        throw new ArgumentException("The same elements expected, but " +
    ...
    //    int argumentCount = firstArguments.Count;
    //    if (argumentCount == 0)
    //    {
    //        return firstType;
    //    }
    ...
    //        }
    //    }
    //    foreach (InterfaceType interfaceType in targetType.interfaces)
    //    {
    ...
    //        }
    //    }
    //    foreach (InterfaceType constraint in targetType.superclassConstraints)
    //    {
    //        ExecutableElement member = _lookUpMemberInInterfaces(
    ...
    //        }
    //    }
    //    foreach (InterfaceType mixinType in targetType.mixins.reversed)
    //    {
    //        ExecutableElement member = _lookUpMemberInInterfaces(
    ...
    //        }
    //    }
    //    InterfaceType superpublic class = targetType.superclass;
    //    if (superpublic class == null)
    //    {
    //        return null;
    //    }
    //    return _lookUpMemberInInterfaces(
    ...
    /**
     * The abstract public class `TypeImpl` implements the behavior common to objects
     * representing the declared type of elements in the element model.
     */
    public abstract class TypeImpl : DartType
    {
        /**
         ...
         */
        public TypeImpl(Element _element, String name)
        {
         ...
         */
        public bool hasTypeParameterReferenceInBound()
        {
            ...
            return (bool)_hasTypeParameterReferenceInBound;
        }

        public bool isBottom => false;

        public bool isDartAsyncFuture => false;

        public bool isDartAsyncFutureOr => false;

        public bool isDartCoreFunction => false;

        public bool isDartCoreNull => false;
         ...
         */
        public abstract TypeImpl pruned(List<FunctionTypeAliasElement> prune);
        ...
        public abstract DartType substitute2(
            List<DartType> argumentTypes, List<DartType> parameterTypes, List<FunctionTypeAliasElement> prune);
     ...
     */
    //public class TypeParameterTypeImpl : TypeImpl, TypeParameterType
    //{
    ...
    //    public DartType bound => element.bound ?? DynamicTypeImpl.instance;

    //    public ElementLocation definition => element.location;

    //    public TypeParameterElement element => base.element as TypeParameterElement;

    //    public int hashCode => element.hashCode;
    ...
    //    public bool isMoreSpecificThan(DartType s,
    //          bool withDynamic = false, HashSet<Element> visitedElements = null)
    //    {
    //        //
    //        // A type T is more specific than a type S, written T << S,
    ...
    //    public bool isSubtypeOf(DartType type) => isMoreSpecificThan(type, true);
    ...
    //    public DartType resolveToBound(DartType objectType)
    //    {
    ...
    //        if (count == 0)
    //        {
    //            return new List<TypeParameterType> { };
    //        }
    ...
    ///**
    // * The unique instance of the public class `UndefinedTypeImpl` implements the type of
    // * type names that couldn't be resolved.
    // *
    // * This public class behaves like DynamicTypeImpl in almost every respect, to reduce
    // * cascading errors.
    // */
    //public class UndefinedTypeImpl : TypeImpl
    //{
    //    /**
    //     * The unique instance of this class.
    //     */
    //    public static UndefinedTypeImpl instance = new UndefinedTypeImpl();

    //    /**
    //     * Prevent the creation of instances of this class.
    //     */
    //    public UndefinedTypeImpl()
    //        : base(DynamicElementImpl.instance, Keyword.DYNAMIC.lexeme) { }
    ...
    // * The type `void`.
    // */
    //public abstract class VoidType : DartType
    //{
    ...
    // */
    //public class VoidTypeImpl : TypeImpl, VoidType
    //{
    //    /**
    //     * The unique instance of this class.
    //     */
    //    public static VoidTypeImpl instance = new VoidTypeImpl();

    //    /**
    //     * Prevent the creation of instances of this class.
    //     */
    //    VoidTypeImpl() : base(null, Keyword.VOID.lexeme) { }
    ...
    //    public VoidTypeImpl substitute2(
    //            List<DartType> argumentTypes, List<DartType> parameterTypes,
    //            List<FunctionTypeAliasElement> prune) =>
    //        this;
    //}
    ...
    // * the element model.
    // */
    //public class _FunctionTypeImplLazy : FunctionTypeImpl
    //{
    //    /**
    //     * The list of [typeArguments].
    //     */
    //    public List<DartType> _typeArguments;
    ...
    //     */
    //    public readonly DartType _returnType;

    //    /**
    //     * The parameters to the function, or `null` if the parameters should be
    //     * accessed through the element.
    //     */
    //    public readonly List<ParameterElement> _parameters;
    ...
    //     */
    //    public readonly bool _isInstantiated;
    ...
    // */
    //public List<ParameterElement> baseParameters =>
    //    _parameters ?? element.parameters;

    ///**
    // * Return the return type defined by this function's element.
    // */
    //public DartType baseReturnType => _returnType ?? element.returnType;
    ...
    //        {
    //            return new List<FunctionTypeAliasElement> { element };
    //        }
    //        else
    //        {
    ...
    //        if (typeParameters.isEmpty)
    //        {
    //            _typeArguments = new List<DartType> { };
    //        }
    //        else
    //        {
    ...
    //    // For example `<U : T>` where T comes from an outer scope.
    ...
    //        while (e != null)
    //        {
    //            // If a static method, skip the enclosing public class type parameters.
    ...
    //public FunctionTypeImpl instantiate(List<DartType> argumentTypes)
    //{
    ...
    //    // Now instantiate([V]), and the result should be:
    //    //     {U/T, V/S} T -> S.
    //    List<DartType> newTypeArgs = new List<DartType> { };
    ...
    //public FunctionTypeImpl pruned(List<FunctionTypeAliasElement> prune)
    //{
    //    if (prune == null)
    //    {
    //        return this;
    ...
    //public class _FunctionTypeImplStrict : FunctionTypeImpl
    //{
    //    public readonly DartType returnType;

    //    public readonly List<TypeParameterElement> typeFormals;

    //    public readonly List<ParameterElement> parameters;

    //    _FunctionTypeImplStrict(this.returnType, this.typeFormals, this.parameters)
    //      : base(null, null)
    //    {
    ...
    //    public bool isInstantiated => throw new NotImplementedException('TODO(paulberry)');

    //    public List<FunctionTypeAliasElement> newPrune => new List<FunctionTypeAliasElement> { };

    //    public List<String> normalParameterNames =>

    //      parameters.where((p) => p.isNotOptional).map((p) => p.name).toList();

    //    public List<String> optionalParameterNames => parameters
    //      .Where((p) => p.isOptionalPositional)
    //      .map((p) => p.name)
    //      .toList();

    //    public List<FunctionTypeAliasElement> prunedTypedefs => new List<FunctionTypeAliasElement> { };

    //    public List<DartType> typeArguments => new List<DartType> { } /*TODO(paulberry)*/;

    //    public List<TypeParameterElement> typeParameters => new List<TypeParameterElement> { } /*TODO(paulberry)*/;
    ...
    //        }
    //        public TypeParameterElement transformTypeFormal(TypeParameterElement p)
    //        {
    //            var bound = p.bound;
    ...
    //    public List<DartType> typeFormalsArgumentTypes;
    //    public List<DartType> typeFormalsParameterTypes;
    ...
    //}
    //public DartType transformType(DartType t)
    //{
    ...
    //public ParameterElement transformParameter(ParameterElement p)
    //{
    //    var type = p.type;
