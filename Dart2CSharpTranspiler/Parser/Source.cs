...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/src/generated/source.dart
...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     */
    public delegate void ContentCacheVisitor(String fullPath, int stamp, String contents);
    ...
    //     */
    //    Dictionary<String, String> _contentMap = new Dictionary<String, String>();
    ...
    //     * overridden.
    //     */
    //    Dictionary<String, int> _stampMap = new Dictionary<String, int>();
    ...
    //     */
    //    public void accept(ContentCacheVisitor visitor)
    //    {
    ...
    //     */
    //    public String getContents(Source source) => _contentMap[source.fullName];
    ...
    //     */
    //    public bool getExists(Source source)
    //    {
    ...
    //     */
    //    public int getModificationStamp(Source source) => _stampMap[source.fullName];
    ...
    //  [Obsolete]
    //public class CustomUriResolver : UriResolver
    //    {
    //        readonly Dictionary<String, String> _urlMappings;

    //        CustomUriResolver(Dictionary<String, String> _urlMappings)
    //        {
    //            this._urlMappings = _urlMappings;
    //        }


    //  public Source resolveAbsolute(Uri uri, [Uri actualUri]) {
     ...
     */
    //    class DartUriResolver : UriResolver
    //    {
    //  /**
     ...
     */
    [Obsolete]
    public class LineInfo_Location
    {
        /**
         ...
         */
        public LineInfo_Location(int lineNumber, int columnNumber)
        {
            this.lineNumber = lineNumber;
            this.columnNumber = columnNumber;
        }

        public virtual String toString() => $"{lineNumber}:{columnNumber}";
    }
     ...
     */
    //    public class NonExistingSource : Source
    //    {
    ...
    // https://github.com/dart-lang/sdk/blob/master/pkg/front_end/lib/src/base/source.dart

    abstract class BasicSource : Source
    {
        //      final Uri uri;
     ...
     */
    public abstract class Source : AnalysisTarget
    {
        /**
         * An empty list of sources.
         */
        public static List<Source> EMPTY_LIST = new List<Source> { };
         ...
         */
        public TimestampedData<String> contents { get; }
