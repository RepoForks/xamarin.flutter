...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/src/analysis_options/error/option_codes.dart
...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     */
    public class AnalysisOptionsErrorCode : ErrorCode
    {
        /**
         ...
         * 3: the error message
         */
        public static AnalysisOptionsErrorCode INCLUDED_FILE_PARSE_ERROR =
          new AnalysisOptionsErrorCode(
         ...
         */
        public static AnalysisOptionsErrorCode PARSE_ERROR =
          new AnalysisOptionsErrorCode("PARSE_ERROR", "{0}");

        /**
         * Initialize a newly created error code to have the given [name].
         */
        public AnalysisOptionsErrorCode(String name, String message,
            String correction = "")
     ...
     * wrong and, when appropriate, how the problem can be corrected.
     */
    public class AnalysisOptionsWarningCode : ErrorCode
    {
        /**
         * An error code indicating that the given option is deprecated.
         */
        public static AnalysisOptionsWarningCode ANALYSIS_OPTION_DEPRECATED =
            new AnalysisOptionsWarningCode("ANALYSIS_OPTION_DEPRECATED",
         ...
         */
        public static AnalysisOptionsWarningCode INCLUDE_FILE_NOT_FOUND =
          new AnalysisOptionsWarningCode("INCLUDE_FILE_NOT_FOUND",
         ...
         */
        public static AnalysisOptionsWarningCode INCLUDED_FILE_WARNING =
          new AnalysisOptionsWarningCode("INCLUDED_FILE_WARNING",
         ...
         */
        public static AnalysisOptionsWarningCode UNRECOGNIZED_ERROR_CODE =
          new AnalysisOptionsWarningCode(
         ...
         * 2: the legal value
         */
        public static AnalysisOptionsWarningCode UNSUPPORTED_OPTION_WITH_LEGAL_VALUE =
          new AnalysisOptionsWarningCode(
         ...
         * 2: legal values
         */
        public static AnalysisOptionsWarningCode UNSUPPORTED_OPTION_WITH_LEGAL_VALUES =
          new AnalysisOptionsWarningCode("UNSUPPORTED_OPTION_WITH_LEGAL_VALUES",
              "The option '{1}' isn't supported by '{0}'.",
         ...
         * 2: legal values
         */
        public static AnalysisOptionsWarningCode UNSUPPORTED_VALUE =
          new AnalysisOptionsWarningCode(
         ...
         * 0: the section name
         */
        public static AnalysisOptionsWarningCode INVALID_SECTION_FORMAT =
          new AnalysisOptionsWarningCode(
         ...
         */
        public static AnalysisOptionsWarningCode SPEC_MODE_REMOVED =
          new AnalysisOptionsWarningCode("SPEC_MODE_REMOVED",
         ...
         */
        public AnalysisOptionsWarningCode(String name, String message,
              String correction = "")
          : base(name, message, correction: correction)
        {
    ...
    public class AnalysisOptionsHintCode : ErrorCode
    {
        /**
         ...
         */
        public static AnalysisOptionsHintCode DEPRECATED_ANALYSIS_OPTIONS_FILE_NAME =
            new AnalysisOptionsHintCode(
         ...
         */
        public static AnalysisOptionsHintCode PREVIEW_DART_2_SETTING_DEPRECATED =
              new AnalysisOptionsHintCode("PREVIEW_DART_2_SETTING_DEPRECATED",
         ...
         */
        public static AnalysisOptionsHintCode STRONG_MODE_SETTING_DEPRECATED =
              new AnalysisOptionsHintCode("STRONG_MODE_SETTING_DEPRECATED",
         ...
         */
        public AnalysisOptionsHintCode(String name, String message,
             String correction = "")
          : base(name, message, correction: correction) { }
