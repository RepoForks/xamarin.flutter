...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/dart/constant/value.dart
...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     */
    public abstract class DartObject
    {
        /**
         ...
         */
        public abstract DartObject getField(String name);
         ...
         */
        public abstract bool toBoolValue();
         ...
         * * the value of the object being represented is `null`.
         */
        public abstract List<DartObject> toListValue();
         ...
         * * the value of the object being represented is `null`.
         */
        public abstract Dictionary<DartObject, DartObject> toMapValue();
         ...
         */
        public abstract String toSymbolValue();
         ...
         * * the value of the object being represented is `null`.
         */
        public abstract DartType toTypeValue();
    }
}