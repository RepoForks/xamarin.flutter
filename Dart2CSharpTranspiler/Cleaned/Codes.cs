...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     * mode).
     */
    public class CheckedModeCompileTimeErrorCode : ErrorCode
    {
         ...
         */
        public static CheckedModeCompileTimeErrorCode
            CONST_CONSTRUCTOR_FIELD_TYPE_MISMATCH =
            new CheckedModeCompileTimeErrorCode(
                "CONST_CONSTRUCTOR_FIELD_TYPE_MISMATCH",
         ...
         * object results in an uncaught exception being thrown.
         */
        public static CheckedModeCompileTimeErrorCode CONST_EVAL_THROWS_EXCEPTION =
          new CheckedModeCompileTimeErrorCode("CONST_EVAL_THROWS_EXCEPTION",
         ...
         */
        public static CheckedModeCompileTimeErrorCode
            LIST_ELEMENT_TYPE_NOT_ASSIGNABLE = new CheckedModeCompileTimeErrorCode(
         ...
         * &lt;= j &lt;= m</i>.
         */
        public static CheckedModeCompileTimeErrorCode MAP_KEY_TYPE_NOT_ASSIGNABLE =
          new CheckedModeCompileTimeErrorCode("MAP_KEY_TYPE_NOT_ASSIGNABLE",
         ...
         * &lt;= j &lt;= m</i>.
         */
        public static CheckedModeCompileTimeErrorCode MAP_VALUE_TYPE_NOT_ASSIGNABLE =
          new CheckedModeCompileTimeErrorCode(
         ...
         * object results in an uncaught exception being thrown.
         */
        public static CheckedModeCompileTimeErrorCode VARIABLE_TYPE_MISMATCH =
          new CheckedModeCompileTimeErrorCode(
         ...
         */
        public CheckedModeCompileTimeErrorCode(String name, String message,
             String correction = "")
      : base(name, message, correction: correction) { }
        ...
        ErrorType type => ErrorType.CHECKED_MODE_COMPILE_TIME_ERROR;
    }
     ...
     */
    public class CompileTimeErrorCode : ErrorCode
    {
        /**
         ...
         */
        public static CompileTimeErrorCode ABSTRACT_SUPER_MEMBER_REFERENCE =
            new CompileTimeErrorCode("ABSTRACT_SUPER_MEMBER_REFERENCE",
         ...
         */
        public static CompileTimeErrorCode ACCESS_PRIVATE_ENUM_FIELD =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode AMBIGUOUS_EXPORT =
              new CompileTimeErrorCode("AMBIGUOUS_EXPORT",
         ...
         *
         * 16.12.2 Const: If <i>e</i> is of the form <i>new T.id(a<sub>1</sub>,
         ...
         */
        public static CompileTimeErrorCode ANNOTATION_WITH_NON_CLASS =
              new CompileTimeErrorCode(
        ...
        public static CompileTimeErrorCode ANNOTATION_WITH_TYPE_ARGUMENTS =
              new CompileTimeErrorCode("ANNOTATION_WITH_TYPE_ARGUMENTS",
         ...
         *    parameter
         */
        public static CompileTimeErrorCode ARGUMENT_DEFINITION_TEST_NON_PARAMETER =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode ASYNC_FOR_IN_WRONG_CONTEXT =
              new CompileTimeErrorCode("ASYNC_FOR_IN_WRONG_CONTEXT",
         ...
         * await expression.)
         */
        public static CompileTimeErrorCode AWAIT_IN_WRONG_CONTEXT =
              new CompileTimeErrorCode("AWAIT_IN_WRONG_CONTEXT",
         ...
         */
        public static CompileTimeErrorCode BUILT_IN_IDENTIFIER_AS_PREFIX_NAME =
              new CompileTimeErrorCode("BUILT_IN_IDENTIFIER_AS_PREFIX_NAME",
         ...
         * 0: the built-in identifier that is being used
         */
        public static CompileTimeErrorCode BUILT_IN_IDENTIFIER_AS_TYPE =
              new CompileTimeErrorCode("BUILT_IN_IDENTIFIER_AS_TYPE",
         ...
         * 0: the built-in identifier that is being used
         */
        public static CompileTimeErrorCode BUILT_IN_IDENTIFIER_AS_TYPE_NAME =
              new CompileTimeErrorCode("BUILT_IN_IDENTIFIER_AS_TYPE_NAME",
         ...
         * 0: the built-in identifier that is being used
         */
        public static CompileTimeErrorCode BUILT_IN_IDENTIFIER_AS_TYPEDEF_NAME =
              new CompileTimeErrorCode("BUILT_IN_IDENTIFIER_AS_TYPEDEF_NAME",
         ...
         * 0: the built-in identifier that is being used
         */
        public static CompileTimeErrorCode BUILT_IN_IDENTIFIER_AS_TYPE_PARAMETER_NAME =
              new CompileTimeErrorCode("BUILT_IN_IDENTIFIER_AS_TYPE_PARAMETER_NAME",
         ...
         */
        public static CompileTimeErrorCode BUILT_IN_IDENTIFIER_IN_DECLARATION =
              new CompileTimeErrorCode("BUILT_IN_IDENTIFIER_IN_DECLARATION",
         ...
         */
        public static CompileTimeErrorCode CASE_EXPRESSION_TYPE_IMPLEMENTS_EQUALS =
              new CompileTimeErrorCode("CASE_EXPRESSION_TYPE_IMPLEMENTS_EQUALS",
         ...
         */
        public static CompileTimeErrorCode CONFLICTING_CONSTRUCTOR_AND_STATIC_FIELD =
              new CompileTimeErrorCode(
         ...
         * 0: the name of the constructor
         */
        public static CompileTimeErrorCode CONFLICTING_CONSTRUCTOR_AND_STATIC_METHOD =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONFLICTING_FIELD_AND_METHOD =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONFLICTING_GENERIC_INTERFACES =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONFLICTING_METHOD_AND_FIELD =
              new CompileTimeErrorCode(
         ...
         * 2: the name of the class defining the field with which the method conflicts
         */
        public static CompileTimeErrorCode CONFLICTING_STATIC_AND_INSTANCE =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONFLICTING_TYPE_VARIABLE_AND_CLASS =
              new CompileTimeErrorCode(
         ...
         * 0: the name of the type variable
         */
        public static CompileTimeErrorCode CONFLICTING_TYPE_VARIABLE_AND_MEMBER =
              new CompileTimeErrorCode(
        ...
        public static CompileTimeErrorCode
         ...
         * object results in an uncaught exception being thrown.
         */
        public static CompileTimeErrorCode CONST_CONSTRUCTOR_THROWS_EXCEPTION =
              new CompileTimeErrorCode("CONST_CONSTRUCTOR_THROWS_EXCEPTION",
        ...
        public static CompileTimeErrorCode
            CONST_CONSTRUCTOR_WITH_FIELD_INITIALIZED_BY_NON_CONST =
              new CompileTimeErrorCode(
                  "CONST_CONSTRUCTOR_WITH_FIELD_INITIALIZED_BY_NON_CONST",
                  "Can't define the new constructor because the field '{0}' " +
         ...
         * generative new constructor, and M does not declare any fields, Cq is
         * also a new constructor.
         */
        public static CompileTimeErrorCode CONST_CONSTRUCTOR_WITH_MIXIN_WITH_FIELD =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONST_CONSTRUCTOR_WITH_NON_CONST_SUPER =
              new CompileTimeErrorCode(
                  "CONST_CONSTRUCTOR_WITH_NON_CONST_SUPER",
                  "Constant constructor can't call non-constant super constructor of " +
                  "'{0}'.",
                  correction: "Try calling a new constructor in the superclass, or " +
                      "removing the keyword 'const' from the constructor.");
         ...
         */
        public static CompileTimeErrorCode CONST_CONSTRUCTOR_WITH_NON_FINAL_FIELD =
              new CompileTimeErrorCode("CONST_CONSTRUCTOR_WITH_NON_FINAL_FIELD",
                  "Can't define a new constructor for a class with non-final fields.",
         ...
         */
        public static CompileTimeErrorCode CONST_DEFERRED_CLASS =
              new CompileTimeErrorCode("CONST_DEFERRED_CLASS",
         ...
         */
        public static CompileTimeErrorCode CONST_FORMAL_PARAMETER =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONST_INITIALIZED_WITH_NON_CONSTANT_VALUE =
         ...
         */
        public static CompileTimeErrorCode CONST_INSTANCE_FIELD =
              new CompileTimeErrorCode("CONST_INSTANCE_FIELD",
         ...
         */
        public static CompileTimeErrorCode CONST_NOT_INITIALIZED =
              new CompileTimeErrorCode("CONST_NOT_INITIALIZED",
                  "The new variable '{0}' must be initialized.",
         ...
         * value.
         */
        public static CompileTimeErrorCode CONST_EVAL_TYPE_BOOL =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONST_EVAL_TYPE_BOOL_NUM_STRING =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONST_EVAL_TYPE_INT =
              new CompileTimeErrorCode(
                  "CONST_EVAL_TYPE_INT",
                  "In constant expressions, operands of this operator must be of type " +
                  "'int'.");
         ...
         * value or to null.
         */
        public static CompileTimeErrorCode CONST_EVAL_TYPE_NUM =
              new CompileTimeErrorCode(
                  "CONST_EVAL_TYPE_NUM",
                  "In constant expressions, operands of this operator must be of type " +
                  "'num'.");
         ...
         * object results in an uncaught exception being thrown.
         */
        public static CompileTimeErrorCode CONST_EVAL_THROWS_EXCEPTION =
              new CompileTimeErrorCode("CONST_EVAL_THROWS_EXCEPTION",
                  "Evaluation of this constant expression throws an exception.");
         ...
         * object results in an uncaught exception being thrown.
         */
        public static CompileTimeErrorCode CONST_EVAL_THROWS_IDBZE =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONST_WITH_INVALID_TYPE_PARAMETERS =
              new CompileTimeErrorCode(
        ...
        /**
         * 16.12.2 Const: If <i>e</i> is of the form <i>new T(a<sub>1</sub>,
         * &hellip;, a<sub>n</sub>, x<sub>n+1</sub>: a<sub>n+1</sub>, &hellip;,
         ...
         */
        public static CompileTimeErrorCode CONST_WITH_NON_CONST =
              new CompileTimeErrorCode("CONST_WITH_NON_CONST",
                  "The constructor being called isn't a new constructor.",
         ...
         * expression.
         */
        public static CompileTimeErrorCode CONST_WITH_NON_CONSTANT_ARGUMENT =
              new CompileTimeErrorCode("CONST_WITH_NON_CONSTANT_ARGUMENT",
         ...
         * 0: the name of the non-type element
         */
        public static CompileTimeErrorCode CONST_WITH_NON_TYPE =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode CONST_WITH_TYPE_PARAMETERS =
              new CompileTimeErrorCode("CONST_WITH_TYPE_PARAMETERS",
         ...
         */
        public static CompileTimeErrorCode CONST_WITH_UNDEFINED_CONSTRUCTOR =
              new CompileTimeErrorCode("CONST_WITH_UNDEFINED_CONSTRUCTOR",
         ...
         * 0: the name of the type
         */
        public static CompileTimeErrorCode CONST_WITH_UNDEFINED_CONSTRUCTOR_DEFAULT =
              new CompileTimeErrorCode("CONST_WITH_UNDEFINED_CONSTRUCTOR_DEFAULT",
         ...
         */
        public static CompileTimeErrorCode DEFAULT_VALUE_IN_FUNCTION_TYPE_ALIAS =
              new CompileTimeErrorCode("DEFAULT_VALUE_IN_FUNCTION_TYPE_ALIAS",
         ...
         * function type.
         */
        public static CompileTimeErrorCode DEFAULT_VALUE_IN_FUNCTION_TYPED_PARAMETER =
              new CompileTimeErrorCode("DEFAULT_VALUE_IN_FUNCTION_TYPED_PARAMETER",
         ...
         */
        public static CompileTimeErrorCode DUPLICATE_CONSTRUCTOR_DEFAULT =
              new CompileTimeErrorCode("DUPLICATE_CONSTRUCTOR_DEFAULT",
         ...
         */
        public static CompileTimeErrorCode DUPLICATE_CONSTRUCTOR_NAME =
              new CompileTimeErrorCode("DUPLICATE_CONSTRUCTOR_NAME",
         ...
         * 0: the name of the duplicate entity
         */
        public static CompileTimeErrorCode DUPLICATE_DEFINITION =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode DUPLICATE_PART = new CompileTimeErrorCode(
              "DUPLICATE_PART",
         ...
         */
        public static CompileTimeErrorCode DUPLICATE_NAMED_ARGUMENT =
              new CompileTimeErrorCode("DUPLICATE_NAMED_ARGUMENT",
         ...
         */
        public static CompileTimeErrorCode EXPORT_INTERNAL_LIBRARY =
              new CompileTimeErrorCode("EXPORT_INTERNAL_LIBRARY",
         ...
         */
        public static CompileTimeErrorCode EXPORT_OF_NON_LIBRARY =
              new CompileTimeErrorCode("EXPORT_OF_NON_LIBRARY",
                  "The exported library '{0}' can't have a part-of directive.",
                  correction: "Try exporting the library that the part is a part of.");

        /**
         * 7.9 Superclasses: It is a compile-time error if the : clause of a
         ...
         */
        public static CompileTimeErrorCode EXTENDS_NON_CLASS = new CompileTimeErrorCode(
              "EXTENDS_NON_CLASS", "Classes can only extend other classes.",
            correction:
                "Try specifying a different superclass, or removing the : clause.");
         ...
         */
        public static CompileTimeErrorCode EXTENDS_DISALLOWED_CLASS =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode EXTENDS_DEFERRED_CLASS =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode EXTRA_POSITIONAL_ARGUMENTS =
              new CompileTimeErrorCode("EXTRA_POSITIONAL_ARGUMENTS",
         ...
         */
        public static CompileTimeErrorCode EXTRA_POSITIONAL_ARGUMENTS_COULD_BE_NAMED =
              new CompileTimeErrorCode("EXTRA_POSITIONAL_ARGUMENTS_COULD_BE_NAMED",
                  "Too many positional arguments: {0} expected, but {1} found.",
         ...
         */
        public static CompileTimeErrorCode FIELD_INITIALIZED_BY_MULTIPLE_INITIALIZERS =
              new CompileTimeErrorCode("FIELD_INITIALIZED_BY_MULTIPLE_INITIALIZERS",
         ...
         */
        public static CompileTimeErrorCode FINAL_INITIALIZED_MULTIPLE_TIMES =
              new CompileTimeErrorCode("FINAL_INITIALIZED_MULTIPLE_TIMES",
         ...
         */
        public static CompileTimeErrorCode FIELD_INITIALIZER_FACTORY_CONSTRUCTOR =
              new CompileTimeErrorCode("FIELD_INITIALIZER_FACTORY_CONSTRUCTOR",
         ...
         * generative constructor.
         */
        public static CompileTimeErrorCode FIELD_INITIALIZER_OUTSIDE_CONSTRUCTOR =
              new CompileTimeErrorCode("FIELD_INITIALIZER_OUTSIDE_CONSTRUCTOR",
         ...
         * generative constructor.
         */
        public static CompileTimeErrorCode FIELD_INITIALIZER_REDIRECTING_CONSTRUCTOR =
              new CompileTimeErrorCode("FIELD_INITIALIZER_REDIRECTING_CONSTRUCTOR",
         ...
         */
        public static CompileTimeErrorCode GENERIC_FUNCTION_TYPED_PARAM_UNSUPPORTED =
              new CompileTimeErrorCode("GENERIC_FUNCTION_TYPED_PARAM_UNSUPPORTED",
         ...
         */
        public static CompileTimeErrorCode IMPLEMENTS_DEFERRED_CLASS =
              new CompileTimeErrorCode("IMPLEMENTS_DEFERRED_CLASS",
         ...
         */
        public static CompileTimeErrorCode IMPLEMENTS_DISALLOWED_CLASS =
              new CompileTimeErrorCode("IMPLEMENTS_DISALLOWED_CLASS",
         ...
         */
        public static CompileTimeErrorCode IMPLEMENTS_NON_CLASS =
              new CompileTimeErrorCode("IMPLEMENTS_NON_CLASS",
         ...
         */
        public static CompileTimeErrorCode IMPLEMENTS_REPEATED =
              new CompileTimeErrorCode(
         ...
         *    clauses
         */
        public static CompileTimeErrorCode IMPLEMENTS_SUPER_CLASS =
              new CompileTimeErrorCode("IMPLEMENTS_SUPER_CLASS",
         ...
         * variable.
         */
        public static CompileTimeErrorCode IMPLICIT_THIS_REFERENCE_IN_INITIALIZER =
         ...
         * 0: the uri pointing to a library
         */
        public static CompileTimeErrorCode IMPORT_INTERNAL_LIBRARY =
              new CompileTimeErrorCode("IMPORT_INTERNAL_LIBRARY",
         ...
         */
        public static CompileTimeErrorCode IMPORT_OF_NON_LIBRARY =
              new CompileTimeErrorCode("IMPORT_OF_NON_LIBRARY",
         ...
         */
        public static CompileTimeErrorCode INCONSISTENT_CASE_EXPRESSION_TYPES =
              new CompileTimeErrorCode("INCONSISTENT_CASE_EXPRESSION_TYPES",
         ...
         */
        public static CompileTimeErrorCode INCONSISTENT_INHERITANCE =
              new CompileTimeErrorCode("INCONSISTENT_INHERITANCE",
         ...
         */
        public static CompileTimeErrorCode INCONSISTENT_INHERITANCE_GETTER_AND_METHOD =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INITIALIZER_FOR_NON_EXISTENT_FIELD =
              new CompileTimeErrorCode("INITIALIZER_FOR_NON_EXISTENT_FIELD",
         ...
         */
        public static CompileTimeErrorCode INITIALIZER_FOR_STATIC_FIELD =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INITIALIZING_FORMAL_FOR_NON_EXISTENT_FIELD =
              new CompileTimeErrorCode("INITIALIZING_FORMAL_FOR_NON_EXISTENT_FIELD",
                  "'{0}' isn't a field in the enclosing class.",
                  correction: "Try correcting the name to match an existing field, or " +
                      "defining a field named '{0}'.");
         ...
         */
        public static CompileTimeErrorCode INITIALIZING_FORMAL_FOR_STATIC_FIELD =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INSTANCE_MEMBER_ACCESS_FROM_FACTORY =
              new CompileTimeErrorCode("INSTANCE_MEMBER_ACCESS_FROM_FACTORY",
         ...
         * extraction <b>this</b>.<i>id</i>.
         */
        public static CompileTimeErrorCode INSTANCE_MEMBER_ACCESS_FROM_STATIC =
              new CompileTimeErrorCode("INSTANCE_MEMBER_ACCESS_FROM_STATIC",
         ...
         * enum via 'new' or 'const' or to access its private fields.
         */
        public static CompileTimeErrorCode INSTANTIATE_ENUM =
              new CompileTimeErrorCode(
                  "INSTANTIATE_ENUM", "Enums can't be instantiated.",
                  correction: "Try using one of the defined constants.");

        public static CompileTimeErrorCode INTEGER_LITERAL_OUT_OF_RANGE =
              new CompileTimeErrorCode("INTEGER_LITERAL_OUT_OF_RANGE",
         ...
         */
        public static CompileTimeErrorCode INTEGER_LITERAL_IMPRECISE_AS_DOUBLE =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INVALID_ANNOTATION =
              new CompileTimeErrorCode(
                  "INVALID_ANNOTATION",
                  "Annotation must be either a new variable reference or new " +
         ...
         * not qualified by a deferred prefix.
         */
        public static CompileTimeErrorCode INVALID_ANNOTATION_FROM_DEFERRED_LIBRARY =
              new CompileTimeErrorCode("INVALID_ANNOTATION_FROM_DEFERRED_LIBRARY",
         ...
         * constant constructor.
         */
        public static CompileTimeErrorCode INVALID_ANNOTATION_GETTER =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INVALID_IDENTIFIER_IN_ASYNC =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INVALID_MODIFIER_ON_CONSTRUCTOR =
              new CompileTimeErrorCode("INVALID_MODIFIER_ON_CONSTRUCTOR",
         ...
         * modifier is attached to the body of a setter or constructor.
         */
        public static CompileTimeErrorCode INVALID_MODIFIER_ON_SETTER =
              new CompileTimeErrorCode("INVALID_MODIFIER_ON_SETTER",
         ...
         */
        public static CompileTimeErrorCode INVALID_CONSTANT =
              new CompileTimeErrorCode("INVALID_CONSTANT", "Invalid constant value.");

        /**
         * 7.6 Constructors: It is a compile-time error if the name of a constructor
         * is not a constructor name.
         */
        public static CompileTimeErrorCode INVALID_CONSTRUCTOR_NAME =
              new CompileTimeErrorCode(
         ...
         * the immediately enclosing class.
         */
        public static CompileTimeErrorCode INVALID_FACTORY_NAME_NOT_A_CLASS =
              new CompileTimeErrorCode(
                  "INVALID_FACTORY_NAME_NOT_A_CLASS",
                  "The name of a factory constructor must be the same as the name of " +
                  "the immediately enclosing class.");

        public static CompileTimeErrorCode INVALID_INLINE_FUNCTION_TYPE =
              new CompileTimeErrorCode("INVALID_INLINE_FUNCTION_TYPE",
         ...
         */
        public static CompileTimeErrorCode INVALID_OVERRIDE =
              new CompileTimeErrorCode("INVALID_OVERRIDE",
         ...
         * variable.
         */
        public static CompileTimeErrorCode INVALID_REFERENCE_TO_THIS =
              new CompileTimeErrorCode("INVALID_REFERENCE_TO_THIS",
         ...
         */
        public static CompileTimeErrorCode INVALID_TYPE_ARGUMENT_IN_CONST_LIST =
              new CompileTimeErrorCode(
         ...
         * 0: the name of the type parameter
         */
        public static CompileTimeErrorCode INVALID_TYPE_ARGUMENT_IN_CONST_MAP =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INVALID_USE_OF_COVARIANT =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode INVALID_URI =
              new CompileTimeErrorCode("INVALID_URI", "Invalid URI syntax: '{0}'.");
         ...
         */
        public static CompileTimeErrorCode LABEL_IN_OUTER_SCOPE =
              new CompileTimeErrorCode("LABEL_IN_OUTER_SCOPE",
         ...
         * 0: the name of the unresolvable label
         */
        public static CompileTimeErrorCode LABEL_UNDEFINED =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MEMBER_WITH_CLASS_NAME =
              new CompileTimeErrorCode("MEMBER_WITH_CLASS_NAME",
                  "Class members can't have the same name as the enclosing class.");

        /**
         * 12.1 Constants: A constant expression is ... a constant list literal.
         */
        public static CompileTimeErrorCode MISSING_CONST_IN_LIST_LITERAL =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MISSING_CONST_IN_MAP_LITERAL =
              new CompileTimeErrorCode(
        ...
        public static CompileTimeErrorCode MISSING_DART_LIBRARY =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode
            MIXIN_APPLICATION_NOT_IMPLEMENTED_INTERFACE = new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MIXIN_CLASS_DECLARES_CONSTRUCTOR =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MIXIN_DECLARES_CONSTRUCTOR =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MIXIN_DEFERRED_CLASS =
              new CompileTimeErrorCode(
        ...
        public static CompileTimeErrorCode MIXIN_INFERENCE_NO_MATCHING_CLASS =
              new CompileTimeErrorCode(
        ...
        public static CompileTimeErrorCode MIXIN_INFERENCE_NO_POSSIBLE_SUBSTITUTION =
              new CompileTimeErrorCode(
         ...
         * 0: the name of the mixin that is invalid
         */
        public static CompileTimeErrorCode MIXIN_INHERITS_FROM_NOT_OBJECT =
              new CompileTimeErrorCode(
                  "MIXIN_INHERITS_FROM_NOT_OBJECT",
                  "The class '{0}' can't be used as a mixin because it : a class " +
                  "other than Object.");

        /**
         * A mixin declaration introduces a mixin and an interface, but not a class.
         */
        public static CompileTimeErrorCode MIXIN_INSTANTIATE =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MIXIN_OF_DISALLOWED_CLASS =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MIXIN_OF_NON_CLASS =
              new CompileTimeErrorCode(
         ...
         * to super.
         */
        public static CompileTimeErrorCode MIXIN_REFERENCES_SUPER =
              new CompileTimeErrorCode(
        ...
        public static CompileTimeErrorCode
            MIXIN_SUPER_CLASS_CONSTRAINT_DEFERRED_CLASS = new CompileTimeErrorCode(
        ...
        public static CompileTimeErrorCode MIXIN_SUPER_CLASS_CONSTRAINT_NON_INTERFACE =
              new CompileTimeErrorCode("MIXIN_SUPER_CLASS_CONSTRAINT_NON_INTERFACE",
         ...
         */
        public static CompileTimeErrorCode MIXIN_WITH_NON_CLASS_SUPERCLASS =
              new CompileTimeErrorCode("MIXIN_WITH_NON_CLASS_SUPERCLASS",
         ...
         */
        public static CompileTimeErrorCode
            MULTIPLE_REDIRECTING_CONSTRUCTOR_INVOCATIONS = new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode MULTIPLE_SUPER_INITIALIZERS =
              new CompileTimeErrorCode("MULTIPLE_SUPER_INITIALIZERS",
         ...
         * constant constructor.
         */
        public static CompileTimeErrorCode NO_ANNOTATION_CONSTRUCTOR_ARGUMENTS =
              new CompileTimeErrorCode("NO_ANNOTATION_CONSTRUCTOR_ARGUMENTS",
         ...
         *    constructor
         */
        public static CompileTimeErrorCode NO_DEFAULT_SUPER_CONSTRUCTOR_EXPLICIT =
              new CompileTimeErrorCode("NO_DEFAULT_SUPER_CONSTRUCTOR_EXPLICIT",
         ...
         */
        public static CompileTimeErrorCode NO_DEFAULT_SUPER_CONSTRUCTOR_IMPLICIT =
              new CompileTimeErrorCode("NO_DEFAULT_SUPER_CONSTRUCTOR_IMPLICIT",
                  "The superclass '{0}' doesn't have a zero argument constructor.",
                  correction: "Try declaring a zero argument constructor in '{0}', or " +
         ...
         */
        public static CompileTimeErrorCode NON_CONST_MAP_AS_EXPRESSION_STATEMENT =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode NON_CONSTANT_CASE_EXPRESSION =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode NON_CONSTANT_DEFAULT_VALUE =
              new CompileTimeErrorCode("NON_CONSTANT_DEFAULT_VALUE",
         ...
         */
        public static CompileTimeErrorCode NON_CONSTANT_LIST_ELEMENT =
              new CompileTimeErrorCode("NON_CONSTANT_LIST_ELEMENT",
                  "The values in a new list literal must be constants.",
         ...
         */
        public static CompileTimeErrorCode NON_CONSTANT_MAP_KEY =
              new CompileTimeErrorCode("NON_CONSTANT_MAP_KEY",
                  "The keys in a new map literal must be constant.",
                  correction: "Try removing the keyword 'const' from the map literal.");
         ...
         * not qualified by a deferred prefix.
         */
        public static CompileTimeErrorCode NON_CONSTANT_MAP_KEY_FROM_DEFERRED_LIBRARY =
              new CompileTimeErrorCode(
         ...
         * entry in a constant map literal is not a compile-time constant.
         */
        public static CompileTimeErrorCode NON_CONSTANT_MAP_VALUE =
              new CompileTimeErrorCode("NON_CONSTANT_MAP_VALUE",
                  "The values in a new map literal must be constant.",
                  correction: "Try removing the keyword 'const' from the map literal.");
         ...
         */
        public static CompileTimeErrorCode
            NON_CONSTANT_MAP_VALUE_FROM_DEFERRED_LIBRARY = new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode NON_CONSTANT_ANNOTATION_CONSTRUCTOR =
              new CompileTimeErrorCode("NON_CONSTANT_ANNOTATION_CONSTRUCTOR",
                  "Annotation creation can only call a new constructor.");
         ...
         */
        public static CompileTimeErrorCode NON_CONSTANT_VALUE_IN_INITIALIZER =
              new CompileTimeErrorCode("NON_CONSTANT_VALUE_IN_INITIALIZER",
        ...
        public static CompileTimeErrorCode NON_SYNC_FACTORY =
              new CompileTimeErrorCode("NON_SYNC_FACTORY",
         ...
         * 1: the actual number of positional arguments given
         */
        public static CompileTimeErrorCode NOT_ENOUGH_REQUIRED_ARGUMENTS =
              new CompileTimeErrorCode("NOT_ENOUGH_REQUIRED_ARGUMENTS",
         ...
         */
        public static CompileTimeErrorCode NON_GENERATIVE_CONSTRUCTOR =
              new CompileTimeErrorCode("NON_GENERATIVE_CONSTRUCTOR",
        ...
        /**
         * 7.9 Superclasses: It is a compile-time error to specify an : clause
         * for class Object.
         */
        public static CompileTimeErrorCode OBJECT_CANNOT_EXTEND_ANOTHER_CLASS =
              new CompileTimeErrorCode("OBJECT_CANNOT_EXTEND_ANOTHER_CLASS",
         ...
         * 0: the name of the interface that is implemented more than once
         */
        public static CompileTimeErrorCode ON_REPEATED = new CompileTimeErrorCode(
              "ON_REPEATED",
         ...
         */
        public static CompileTimeErrorCode OPTIONAL_PARAMETER_IN_OPERATOR =
              new CompileTimeErrorCode("OPTIONAL_PARAMETER_IN_OPERATOR",
         ...
         * 0: the uri pointing to a non-library declaration
         */
        public static CompileTimeErrorCode PART_OF_NON_PART =
              new CompileTimeErrorCode("PART_OF_NON_PART",
         ...
         */
        public static CompileTimeErrorCode PREFIX_COLLIDES_WITH_TOP_LEVEL_MEMBER =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode PREFIX_IDENTIFIER_NOT_FOLLOWED_BY_DOT =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode PRIVATE_COLLISION_IN_MIXIN_APPLICATION =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode PRIVATE_OPTIONAL_PARAMETER =
              new CompileTimeErrorCode("PRIVATE_OPTIONAL_PARAMETER",
         ...
         */
        public static CompileTimeErrorCode RECURSIVE_COMPILE_TIME_CONSTANT =
              new CompileTimeErrorCode("RECURSIVE_COMPILE_TIME_CONSTANT",
         ...
         */
        public static CompileTimeErrorCode RECURSIVE_CONSTRUCTOR_REDIRECT =
              new CompileTimeErrorCode("RECURSIVE_CONSTRUCTOR_REDIRECT",
         ...
         */
        public static CompileTimeErrorCode RECURSIVE_FACTORY_REDIRECT =
              new CompileTimeErrorCode("RECURSIVE_FACTORY_REDIRECT",
         ...
         */
        public static CompileTimeErrorCode RECURSIVE_INTERFACE_INHERITANCE =
              new CompileTimeErrorCode("RECURSIVE_INTERFACE_INHERITANCE",
         ...
         * 0: the name of the class that implements itself recursively
         */
        public static CompileTimeErrorCode RECURSIVE_INTERFACE_INHERITANCE_EXTENDS =
              new CompileTimeErrorCode("RECURSIVE_INTERFACE_INHERITANCE_EXTENDS",
         ...
         * 0: the name of the class that implements itself recursively
         */
        public static CompileTimeErrorCode RECURSIVE_INTERFACE_INHERITANCE_IMPLEMENTS =
              new CompileTimeErrorCode("RECURSIVE_INTERFACE_INHERITANCE_IMPLEMENTS",
         ...
         */
        public static CompileTimeErrorCode RECURSIVE_INTERFACE_INHERITANCE_ON =
              new CompileTimeErrorCode("RECURSIVE_INTERFACE_INHERITANCE_ON",
         ...
         * 0: the name of the class that implements itself recursively
         */
        public static CompileTimeErrorCode RECURSIVE_INTERFACE_INHERITANCE_WITH =
              new CompileTimeErrorCode("RECURSIVE_INTERFACE_INHERITANCE_WITH",
                  "'{0}' can't use itself as a mixin.");

        /**
         * 7.6.2 Factories: It is a compile-time error if <i>k</i> is prefixed with
         * the new modifier but <i>k'</i> is not a constant constructor.
         */
        public static CompileTimeErrorCode REDIRECT_TO_MISSING_CONSTRUCTOR =
              new CompileTimeErrorCode("REDIRECT_TO_MISSING_CONSTRUCTOR",
         ...
         * the new modifier but <i>k'</i> is not a constant constructor.
         */
        public static CompileTimeErrorCode REDIRECT_TO_NON_CLASS =
              new CompileTimeErrorCode(
         ...
         * the new modifier but <i>k'</i> is not a constant constructor.
         */
        public static CompileTimeErrorCode REDIRECT_TO_NON_CONST_CONSTRUCTOR =
              new CompileTimeErrorCode(
         ...
         * generative constructor.
         */
        public static CompileTimeErrorCode REDIRECT_GENERATIVE_TO_MISSING_CONSTRUCTOR =
              new CompileTimeErrorCode("REDIRECT_GENERATIVE_TO_MISSING_CONSTRUCTOR",
                  "The constructor '{0}' couldn't be found in '{1}'.",
                  correction: "Try redirecting to a different constructor, or " +
         ...
         */
        public static CompileTimeErrorCode REFERENCED_BEFORE_DECLARATION =
              new CompileTimeErrorCode("REFERENCED_BEFORE_DECLARATION",
         ...
         */
        public static CompileTimeErrorCode RETHROW_OUTSIDE_CATCH =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode RETURN_IN_GENERATIVE_CONSTRUCTOR =
              new CompileTimeErrorCode("RETURN_IN_GENERATIVE_CONSTRUCTOR",
         ...
         */
        public static CompileTimeErrorCode RETURN_IN_GENERATOR = new CompileTimeErrorCode(
              "RETURN_IN_GENERATOR",
         ...
         */
        public static CompileTimeErrorCode SHARED_DEFERRED_PREFIX =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode SUPER_IN_INVALID_CONTEXT =
              new CompileTimeErrorCode("SUPER_IN_INVALID_CONTEXT",
         ...
         * in which case its only action is to invoke another generative constructor.
         */
        public static CompileTimeErrorCode SUPER_IN_REDIRECTING_CONSTRUCTOR =
              new CompileTimeErrorCode("SUPER_IN_REDIRECTING_CONSTRUCTOR",
         ...
         */
        public static CompileTimeErrorCode SUPER_INITIALIZER_IN_OBJECT =
              new CompileTimeErrorCode("SUPER_INITIALIZER_IN_OBJECT",
         ...
         */
        public static CompileTimeErrorCode TYPE_ARGUMENT_NOT_MATCHING_BOUNDS =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode GENERIC_FUNCTION_TYPE_CANNOT_BE_BOUND =
              new CompileTimeErrorCode("GENERIC_FUNCTION_TYPE_CANNOT_BE_BOUND",
        ...
        public static CompileTimeErrorCode FOR_IN_WITH_CONST_VARIABLE =
              new CompileTimeErrorCode("FOR_IN_WITH_CONST_VARIABLE",
         ...
         * type argument.
         */
        public static CompileTimeErrorCode GENERIC_FUNCTION_CANNOT_BE_TYPE_ARGUMENT =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode TYPE_ALIAS_CANNOT_REFERENCE_ITSELF =
              new CompileTimeErrorCode(
                  "TYPE_ALIAS_CANNOT_REFERENCE_ITSELF",
                  "Typedefs can't reference themselves directly or recursively via " +
                  "another typedef.");

        public static CompileTimeErrorCode TYPE_PARAMETER_ON_CONSTRUCTOR =
              new CompileTimeErrorCode("TYPE_PARAMETER_ON_CONSTRUCTOR",
         ...
         * constant constructor.
         */
        public static CompileTimeErrorCode UNDEFINED_ANNOTATION =
              new CompileTimeErrorCode(
         ...
         * accessible in the current scope, optionally followed by type arguments.
         */
        public static CompileTimeErrorCode UNDEFINED_CLASS =
              new CompileTimeErrorCode("UNDEFINED_CLASS", "Undefined class '{0}'.",
         ...
         */
        public static CompileTimeErrorCode UNDEFINED_CONSTRUCTOR_IN_INITIALIZER =
              new CompileTimeErrorCode("UNDEFINED_CONSTRUCTOR_IN_INITIALIZER",
         ...
         */
        public static CompileTimeErrorCode
            UNDEFINED_CONSTRUCTOR_IN_INITIALIZER_DEFAULT = new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode UNDEFINED_NAMED_PARAMETER =
              new CompileTimeErrorCode("UNDEFINED_NAMED_PARAMETER",
         ...
         */
        public static CompileTimeErrorCode URI_DOES_NOT_EXIST =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode URI_HAS_NOT_BEEN_GENERATED =
              new CompileTimeErrorCode("URI_HAS_NOT_BEEN_GENERATED",
         ...
         */
        public static CompileTimeErrorCode URI_WITH_INTERPOLATION =
              new CompileTimeErrorCode(
         ...
         */
        public static CompileTimeErrorCode WRONG_NUMBER_OF_PARAMETERS_FOR_OPERATOR =
              new CompileTimeErrorCode("WRONG_NUMBER_OF_PARAMETERS_FOR_OPERATOR",
         ...
         */
        public static CompileTimeErrorCode WRONG_NUMBER_OF_PARAMETERS_FOR_SETTER =
              new CompileTimeErrorCode("WRONG_NUMBER_OF_PARAMETERS_FOR_SETTER",
         ...
         */
        public static CompileTimeErrorCode YIELD_EACH_IN_NON_GENERATOR =
              new CompileTimeErrorCode(
         ...
         * function that is not a generator function.
         */
        public static CompileTimeErrorCode YIELD_IN_NON_GENERATOR =
              new CompileTimeErrorCode(
         ...
         * given [correction] template.
         */
        public CompileTimeErrorCode(String name, String message,
        ...
        public ErrorSeverity errorSeverity => ErrorType.COMPILE_TIME_ERROR.severity;
     ...
     * when appropriate, how the problem can be corrected.
     */
    public class StaticTypeWarningCode : ErrorCode
    {
        /**
         ...
         */
        public static StaticTypeWarningCode EXPECTED_ONE_LIST_TYPE_ARGUMENTS =
            new StaticTypeWarningCode(
         ...
         * 0: the number of provided type arguments
         */
        public static StaticTypeWarningCode EXPECTED_TWO_MAP_TYPE_ARGUMENTS =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode ILLEGAL_ASYNC_GENERATOR_RETURN_TYPE =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode ILLEGAL_ASYNC_RETURN_TYPE =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode ILLEGAL_SYNC_GENERATOR_RETURN_TYPE =
              new StaticTypeWarningCode("ILLEGAL_SYNC_GENERATOR_RETURN_TYPE",
         ...
         */
        public static StaticTypeWarningCode INSTANCE_ACCESS_TO_STATIC_MEMBER =
              new StaticTypeWarningCode("INSTANCE_ACCESS_TO_STATIC_MEMBER",
         ...
         */
        public static StaticTypeWarningCode INVALID_ASSIGNMENT =
              new StaticTypeWarningCode("INVALID_ASSIGNMENT",
         ...
         */
        public static StaticTypeWarningCode INVOCATION_OF_NON_FUNCTION =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode INVOCATION_OF_NON_FUNCTION_EXPRESSION =
              new StaticTypeWarningCode("INVOCATION_OF_NON_FUNCTION_EXPRESSION",
         ...
         * assigned to bool.
         */
        public static StaticTypeWarningCode NON_BOOL_CONDITION =
              new StaticTypeWarningCode(
         ...
         * be assigned to bool.
         */
        public static StaticTypeWarningCode NON_BOOL_EXPRESSION =
              new StaticTypeWarningCode("NON_BOOL_EXPRESSION",
         ...
         * <i>e<sub>1</sub></i> may not be assigned to bool.
         */
        public static StaticTypeWarningCode NON_BOOL_NEGATION_EXPRESSION =
              new StaticTypeWarningCode("NON_BOOL_NEGATION_EXPRESSION",
         ...
         */
        public static StaticTypeWarningCode NON_BOOL_OPERAND =
              new StaticTypeWarningCode("NON_BOOL_OPERAND",
         ...
         */
        public static StaticTypeWarningCode NON_TYPE_AS_TYPE_ARGUMENT =
              new StaticTypeWarningCode("NON_TYPE_AS_TYPE_ARGUMENT",
         ...
         */
        public static StaticTypeWarningCode RETURN_OF_INVALID_TYPE =
              new StaticTypeWarningCode("RETURN_OF_INVALID_TYPE",
         ...
         * 1: the expected return type as defined by the method
         */
        public static StaticTypeWarningCode RETURN_OF_INVALID_TYPE_FROM_CLOSURE =
              new StaticTypeWarningCode("RETURN_OF_INVALID_TYPE_FROM_CLOSURE",
         ...
         */
        public static StaticTypeWarningCode TYPE_ARGUMENT_NOT_MATCHING_BOUNDS =
              new StaticTypeWarningCode(
                  "TYPE_ARGUMENT_NOT_MATCHING_BOUNDS", "'{0}' doesn't extend '{1}'.",
                  correction: "Try using a type that is or is a subclass of '{1}'.");
         ...
         */
        public static StaticTypeWarningCode TYPE_PARAMETER_SUPERTYPE_OF_ITS_BOUND =
              new StaticTypeWarningCode("TYPE_PARAMETER_SUPERTYPE_OF_ITS_BOUND",
         ...
         */
        public static StaticTypeWarningCode UNDEFINED_ENUM_CONSTANT =
              new StaticTypeWarningCode("UNDEFINED_ENUM_CONSTANT",
         ...
         */
        public static StaticTypeWarningCode UNDEFINED_FUNCTION =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode UNDEFINED_GETTER =
              new StaticTypeWarningCode("UNDEFINED_GETTER",
         ...
         */
        public static StaticTypeWarningCode UNDEFINED_METHOD =
              new StaticTypeWarningCode("UNDEFINED_METHOD",
         ...
         * 1: the resolved type name that the method lookup is happening on
         */
        public static StaticTypeWarningCode UNDEFINED_METHOD_WITH_CONSTRUCTOR =
              new StaticTypeWarningCode("UNDEFINED_METHOD_WITH_CONSTRUCTOR",
         ...
         */
        public static StaticTypeWarningCode UNDEFINED_OPERATOR =
              new StaticTypeWarningCode("UNDEFINED_OPERATOR",
         ...
         */
        public static StaticTypeWarningCode UNDEFINED_SETTER =
              new StaticTypeWarningCode("UNDEFINED_SETTER",
         ...
         * 1: the name of the enclosing type where the getter is being looked for
         */
        public static StaticTypeWarningCode UNDEFINED_SUPER_GETTER =
              new StaticTypeWarningCode("UNDEFINED_SUPER_GETTER",
         ...
         * 1: the resolved type name that the method lookup is happening on
         */
        public static StaticTypeWarningCode UNDEFINED_SUPER_METHOD =
              new StaticTypeWarningCode("UNDEFINED_SUPER_METHOD",
         ...
         * 1: the name of the enclosing type where the operator is being looked for
         */
        public static StaticTypeWarningCode UNDEFINED_SUPER_OPERATOR =
              new StaticTypeWarningCode("UNDEFINED_SUPER_OPERATOR",
         ...
         * 1: the name of the enclosing type where the setter is being looked for
         */
        public static StaticTypeWarningCode UNDEFINED_SUPER_SETTER =
              new StaticTypeWarningCode("UNDEFINED_SUPER_SETTER",
         ...
         */
        public static StaticTypeWarningCode
         ...
         */
        public static StaticTypeWarningCode WRONG_NUMBER_OF_TYPE_ARGUMENTS =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode
            WRONG_NUMBER_OF_TYPE_ARGUMENTS_CONSTRUCTOR = new StaticTypeWarningCode(
         ...
         * 2: the number of type arguments provided
         */
        public static StaticTypeWarningCode WRONG_NUMBER_OF_TYPE_ARGUMENTS_METHOD =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode YIELD_OF_INVALID_TYPE =
              new StaticTypeWarningCode(
         ...
         */
        public static StaticTypeWarningCode FOR_IN_OF_INVALID_TYPE =
              new StaticTypeWarningCode("FOR_IN_OF_INVALID_TYPE",
         ...
         */
        public static StaticTypeWarningCode FOR_IN_OF_INVALID_ELEMENT_TYPE =
              new StaticTypeWarningCode(
        ...
        public readonly ErrorSeverity errorSeverity;
         ...
         * given [correction] template.
         */
        public StaticTypeWarningCode(String name, String message, String correction = "",
        ...
        public ErrorType type => ErrorType.STATIC_TYPE_WARNING;
    }
     ...
     */
    public class StaticWarningCode : ErrorCode
    {
        /**
         ...
         */
        public static StaticWarningCode AMBIGUOUS_IMPORT = new StaticWarningCode(
         ...
         * 1: the name of the expected type
         */
        public static StaticWarningCode ARGUMENT_TYPE_NOT_ASSIGNABLE =
              new StaticWarningCode("ARGUMENT_TYPE_NOT_ASSIGNABLE",
         ...
         */
        public static StaticWarningCode ASSIGNMENT_TO_CONST = new StaticWarningCode(
         ...
         * assignment will also give rise to a static warning for the same reason.
         */
        public static StaticWarningCode ASSIGNMENT_TO_FINAL = new StaticWarningCode(
              "ASSIGNMENT_TO_FINAL",
         ...
         * assignment will also give rise to a static warning for the same reason.
         */
        public static StaticWarningCode ASSIGNMENT_TO_FINAL_LOCAL =
              new StaticWarningCode("ASSIGNMENT_TO_FINAL_LOCAL",
         ...
         * assignment will also give rise to a static warning for the same reason.
         */
        public static StaticWarningCode ASSIGNMENT_TO_FINAL_NO_SETTER =
              new StaticWarningCode("ASSIGNMENT_TO_FINAL_NO_SETTER",
         ...
         */
        public static StaticWarningCode ASSIGNMENT_TO_FUNCTION =
              new StaticWarningCode(
         ...
         * instance setter named <i>v=</i>.
         */
        public static StaticWarningCode ASSIGNMENT_TO_METHOD = new StaticWarningCode(
         ...
         * name <i>v=</i> in the lexical scope enclosing the assignment.
         */
        public static StaticWarningCode ASSIGNMENT_TO_TYPE = new StaticWarningCode(
         ...
         * or throw statement.
         */
        public static StaticWarningCode CASE_BLOCK_NOT_TERMINATED =
              new StaticWarningCode(
         ...
         */
        public static StaticWarningCode CAST_TO_NON_TYPE = new StaticWarningCode(
              "CAST_TO_NON_TYPE",
         ...
         */
        public static StaticWarningCode CONCRETE_CLASS_WITH_ABSTRACT_MEMBER =
              new StaticWarningCode("CONCRETE_CLASS_WITH_ABSTRACT_MEMBER",
         ...
         * factory constructor.
         */
        public static StaticWarningCode CONST_WITH_ABSTRACT_CLASS =
              new StaticWarningCode("CONST_WITH_ABSTRACT_CLASS",
         ...
         * literal are equal.
         */
        public static StaticWarningCode EQUAL_KEYS_IN_MAP = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode EXPORT_DUPLICATED_LIBRARY_NAMED =
              new StaticWarningCode("EXPORT_DUPLICATED_LIBRARY_NAMED",
         ...
         * See [NOT_ENOUGH_REQUIRED_ARGUMENTS].
         */
        public static StaticWarningCode EXTRA_POSITIONAL_ARGUMENTS =
              new StaticWarningCode("EXTRA_POSITIONAL_ARGUMENTS",
                  "Too many positional arguments: {0} expected, but {1} found.",
                  correction: "Try removing the extra positional arguments.");
         ...
         * See [NOT_ENOUGH_REQUIRED_ARGUMENTS].
         */
        public static StaticWarningCode EXTRA_POSITIONAL_ARGUMENTS_COULD_BE_NAMED =
              new StaticWarningCode("EXTRA_POSITIONAL_ARGUMENTS_COULD_BE_NAMED",
                  "Too many positional arguments: {0} expected, but {1} found.",
                  correction: "Try removing the extra positional arguments, " +
                      "or specifying the name for named arguments.");
         ...
         * constructor.
         */
        public static StaticWarningCode
         ...
         * 1: the name of the type of the field
         */
        public static StaticWarningCode FIELD_INITIALIZER_NOT_ASSIGNABLE =
              new StaticWarningCode("FIELD_INITIALIZER_NOT_ASSIGNABLE",
         ...
         * 1: the name of the type of the field
         */
        public static StaticWarningCode FIELD_INITIALIZING_FORMAL_NOT_ASSIGNABLE =
              new StaticWarningCode("FIELD_INITIALIZING_FORMAL_NOT_ASSIGNABLE",
         ...
         * 0: the name of the uninitialized final variable
         */
        public static StaticWarningCode FINAL_NOT_INITIALIZED =
              new StaticWarningCode("FINAL_NOT_INITIALIZED",
         ...
         * 0: the name of the uninitialized final variable
         */
        public static StaticWarningCode FINAL_NOT_INITIALIZED_CONSTRUCTOR_1 =
              new StaticWarningCode("FINAL_NOT_INITIALIZED_CONSTRUCTOR_1",
                  "The final variable '{0}' must be initialized.",
         ...
         */
        public static StaticWarningCode FINAL_NOT_INITIALIZED_CONSTRUCTOR_2 =
              new StaticWarningCode("FINAL_NOT_INITIALIZED_CONSTRUCTOR_2",
         ...
         */
        public static StaticWarningCode FINAL_NOT_INITIALIZED_CONSTRUCTOR_3_PLUS =
              new StaticWarningCode("FINAL_NOT_INITIALIZED_CONSTRUCTOR_3",
         ...
         */
        public static StaticWarningCode FUNCTION_WITHOUT_CALL = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode IMPORT_DUPLICATED_LIBRARY_NAMED =
              new StaticWarningCode("IMPORT_DUPLICATED_LIBRARY_NAMED",
         ...
         */
        public static StaticWarningCode IMPORT_OF_NON_LIBRARY =
              new StaticWarningCode("IMPORT_OF_NON_LIBRARY",
                  "The imported library '{0}' can't have a part-of directive.",
                  correction: "Try importing the library that the part is a part of.");
         ...
         */
        public static StaticWarningCode
            INVALID_OVERRIDE_DIFFERENT_DEFAULT_VALUES_NAMED = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode INVALID_OVERRIDE_NAMED =
              new StaticWarningCode(
         ...
         * 2: the name of the class from the overridden method
         */
        public static StaticWarningCode INVALID_OVERRIDE_POSITIONAL =
              new StaticWarningCode(
         ...
         * 2: the name of the class from the overridden method
         */
        public static StaticWarningCode INVALID_OVERRIDE_REQUIRED =
              new StaticWarningCode(
         ...
         */
        public static StaticWarningCode INVALID_SETTER_OVERRIDE_NORMAL_PARAM_TYPE =
              new StaticWarningCode(
         ...
         * &lt;= j &lt;= m</i>.
         */
        public static StaticWarningCode LIST_ELEMENT_TYPE_NOT_ASSIGNABLE =
              new StaticWarningCode("LIST_ELEMENT_TYPE_NOT_ASSIGNABLE",
                  "The element type '{0}' can't be assigned to the list type '{1}'.");
         ...
         * &lt;= j &lt;= m</i>.
         */
        public static StaticWarningCode MAP_KEY_TYPE_NOT_ASSIGNABLE =
              new StaticWarningCode("MAP_KEY_TYPE_NOT_ASSIGNABLE",
                  "The element type '{0}' can't be assigned to the map key type '{1}'.");
         ...
         * &lt;= j &lt;= m</i>.
         */
        public static StaticWarningCode MAP_VALUE_TYPE_NOT_ASSIGNABLE =
              new StaticWarningCode("MAP_VALUE_TYPE_NOT_ASSIGNABLE",
         ...
         */
        public static StaticWarningCode MISMATCHED_GETTER_AND_SETTER_TYPES =
              new StaticWarningCode(
         ...
         */
        public static StaticWarningCode MISSING_ENUM_CONSTANT_IN_SWITCH =
              new StaticWarningCode(
         ...
         */
        public static StaticWarningCode MIXED_RETURN_TYPES = new StaticWarningCode(
              "MIXED_RETURN_TYPES",
         ...
         */
        public static StaticWarningCode NEW_WITH_ABSTRACT_CLASS =
              new StaticWarningCode("NEW_WITH_ABSTRACT_CLASS",
         ...
         * [StaticTypeWarningCode.WRONG_NUMBER_OF_TYPE_ARGUMENTS].
         */
        public static StaticWarningCode NEW_WITH_INVALID_TYPE_PARAMETERS =
              new StaticWarningCode(
         ...
         * 0: the name of the non-type element
         */
        public static StaticWarningCode NEW_WITH_NON_TYPE = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode NEW_WITH_UNDEFINED_CONSTRUCTOR =
              new StaticWarningCode("NEW_WITH_UNDEFINED_CONSTRUCTOR",
                  "The class '{0}' doesn't have a constructor named '{1}'.",
         ...
         */
        public static StaticWarningCode NEW_WITH_UNDEFINED_CONSTRUCTOR_DEFAULT =
              new StaticWarningCode("NEW_WITH_UNDEFINED_CONSTRUCTOR_DEFAULT",
         ...
         */
        public static StaticWarningCode
            NON_ABSTRACT_CLASS_INHERITS_ABSTRACT_MEMBER_ONE = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode
            NON_ABSTRACT_CLASS_INHERITS_ABSTRACT_MEMBER_TWO = new StaticWarningCode(
         ...
         * 0: the name of the non-type element
         */
        public static StaticWarningCode NON_TYPE_IN_CATCH_CLAUSE =
              new StaticWarningCode("NON_TYPE_IN_CATCH_CLAUSE",
         ...
         */
        public static StaticWarningCode NON_VOID_RETURN_FOR_OPERATOR =
              new StaticWarningCode("NON_VOID_RETURN_FOR_OPERATOR",
         ...
         * other than void.
         */
        public static StaticWarningCode NON_VOID_RETURN_FOR_SETTER =
              new StaticWarningCode("NON_VOID_RETURN_FOR_SETTER",
         ...
         */
        public static StaticWarningCode NOT_A_TYPE = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode NOT_ENOUGH_REQUIRED_ARGUMENTS =
              new StaticWarningCode("NOT_ENOUGH_REQUIRED_ARGUMENTS",
                  "{0} required argument(s) expected, but {1} found.",
         ...
         */
        public static StaticWarningCode PART_OF_DIFFERENT_LIBRARY =
              new StaticWarningCode("PART_OF_DIFFERENT_LIBRARY",
         ...
         */
        public static StaticWarningCode REDIRECT_TO_INVALID_FUNCTION_TYPE =
              new StaticWarningCode("REDIRECT_TO_INVALID_FUNCTION_TYPE",
         ...
         */
        public static StaticWarningCode REDIRECT_TO_INVALID_RETURN_TYPE =
              new StaticWarningCode("REDIRECT_TO_INVALID_RETURN_TYPE",
         ...
         */
        public static StaticWarningCode REDIRECT_TO_MISSING_CONSTRUCTOR =
              new StaticWarningCode("REDIRECT_TO_MISSING_CONSTRUCTOR",
                  "The constructor '{0}' couldn't be found in '{1}'.",
                  correction:
         ...
         * <i>type.id</i>) is not a constructor of <i>C</i>.
         */
        public static StaticWarningCode REDIRECT_TO_NON_CLASS = new StaticWarningCode(
              "REDIRECT_TO_NON_CLASS",
         ...
         */
        public static StaticWarningCode RETURN_WITHOUT_VALUE = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode STATIC_ACCESS_TO_INSTANCE_MEMBER =
              new StaticWarningCode("STATIC_ACCESS_TO_INSTANCE_MEMBER",
         ...
         */
        public static StaticWarningCode SWITCH_EXPRESSION_NOT_ASSIGNABLE =
              new StaticWarningCode(
         ...
         *    annotation
         */
        public static StaticWarningCode TYPE_ANNOTATION_DEFERRED_CLASS =
              new StaticWarningCode("TYPE_ANNOTATION_DEFERRED_CLASS",
         ...
         * available in the current lexical scope.
         */
        public static StaticWarningCode TYPE_TEST_WITH_NON_TYPE =
              new StaticWarningCode("TYPE_TEST_WITH_NON_TYPE",
         ...
         * available in the current lexical scope.
         */
        public static StaticWarningCode TYPE_TEST_WITH_UNDEFINED_NAME =
              new StaticWarningCode("TYPE_TEST_WITH_UNDEFINED_NAME",
         ...
         */
        public static StaticWarningCode TYPE_PARAMETER_REFERENCED_BY_STATIC =
              new StaticWarningCode("TYPE_PARAMETER_REFERENCED_BY_STATIC",
         ...
         */
        public static StaticWarningCode UNDEFINED_CLASS = new StaticWarningCode(
         ...
         */
        public static StaticWarningCode UNDEFINED_CLASS_BOOLEAN =
              new StaticWarningCode(
         ...
         */
        public static StaticWarningCode UNDEFINED_IDENTIFIER =
              new StaticWarningCode("UNDEFINED_IDENTIFIER", "Undefined name '{0}'.",
         ...
         */
        public static StaticWarningCode UNDEFINED_IDENTIFIER_AWAIT =
              new StaticWarningCode("UNDEFINED_IDENTIFIER_AWAIT",
         ...
         * 0: the name of the requested named parameter
         */
        public static StaticWarningCode UNDEFINED_NAMED_PARAMETER =
              new StaticWarningCode("UNDEFINED_NAMED_PARAMETER",
                  "The named parameter '{0}' isn't defined.",
                  correction:
         ...
         * Parameters: none
         */
        public static StaticWarningCode USE_OF_VOID_RESULT = new StaticWarningCode(
              "USE_OF_VOID_RESULT",
         ...
         * given [correction] template.
         */
        public StaticWarningCode(String name, String message,
             String correction = "", bool isUnresolvedIdentifier = false)
          : base(name, message,
                correction: correction,
                isUnresolvedIdentifier: isUnresolvedIdentifier)
        ...
        public ErrorSeverity errorSeverity => ErrorType.STATIC_WARNING.severity;
     ...
     */
    public class StrongModeCode : ErrorCode
    {
        public static String _implicitCastMessage =
        ...
        public static String _implicitCastCorrection =
         ...
         * back off.
         */
        public static String _implicitDynamicCorrection =
            "Try adding an explicit type like 'dynamic', or " +
          "enable implicit-dynamic in your analysis options file.";

        public static String _inferredTypeMessage = "'{0}' has inferred type '{1}'.";

        public static StrongModeCode DOWN_CAST_COMPOSITE = new StrongModeCode(
              ErrorType.HINT, "DOWN_CAST_COMPOSITE", _implicitCastMessage,


            correction: _implicitCastCorrection);

        public static StrongModeCode DOWN_CAST_IMPLICIT = new StrongModeCode(
              ErrorType.HINT, "DOWN_CAST_IMPLICIT", _implicitCastMessage,


            correction: _implicitCastCorrection);

        public static StrongModeCode DOWN_CAST_IMPLICIT_ASSIGN = new StrongModeCode(
              ErrorType.HINT, "DOWN_CAST_IMPLICIT_ASSIGN", _implicitCastMessage,


            correction: _implicitCastCorrection);

        public static StrongModeCode DYNAMIC_CAST = new StrongModeCode(
              ErrorType.HINT, "DYNAMIC_CAST", _implicitCastMessage,


            correction: _implicitCastCorrection);

        public static StrongModeCode ASSIGNMENT_CAST = new StrongModeCode(
              ErrorType.HINT, "ASSIGNMENT_CAST", _implicitCastMessage,


            correction: _implicitCastCorrection);

        public static StrongModeCode INVALID_PARAMETER_DECLARATION =
              new StrongModeCode(
                  ErrorType.COMPILE_TIME_ERROR,
                  "INVALID_PARAMETER_DECLARATION",
                  "Type check failed: '{0}' isn't of type '{1}'.");

        public static StrongModeCode COULD_NOT_INFER = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "COULD_NOT_INFER",
            "Couldn't infer type parameter '{0}'.{1}");

        public static StrongModeCode INFERRED_TYPE = new StrongModeCode(
              ErrorType.HINT, "INFERRED_TYPE", _inferredTypeMessage);

        public static StrongModeCode INFERRED_TYPE_LITERAL = new StrongModeCode(
              ErrorType.HINT, "INFERRED_TYPE_LITERAL", _inferredTypeMessage);

        public static StrongModeCode INFERRED_TYPE_ALLOCATION = new StrongModeCode(
              ErrorType.HINT, "INFERRED_TYPE_ALLOCATION", _inferredTypeMessage);

        public static StrongModeCode INFERRED_TYPE_CLOSURE = new StrongModeCode(
              ErrorType.HINT, "INFERRED_TYPE_CLOSURE", _inferredTypeMessage);

        public static StrongModeCode INVALID_CAST_LITERAL = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "INVALID_CAST_LITERAL",
            "The literal '{0}' with type '{1}' isn't of expected type '{2}'.");

        public static StrongModeCode INVALID_CAST_LITERAL_LIST = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
        ...
        public static StrongModeCode INVALID_CAST_LITERAL_MAP = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
        ...
        public static StrongModeCode INVALID_CAST_FUNCTION_EXPR = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
        ...
        public static StrongModeCode INVALID_CAST_NEW_EXPR = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
        ...
        public static StrongModeCode INVALID_CAST_METHOD = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "INVALID_CAST_METHOD",
        ...
        public static StrongModeCode INVALID_CAST_FUNCTION = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
        ...
        public static StrongModeCode INVALID_SUPER_INVOCATION = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "INVALID_SUPER_INVOCATION",
            "super call must be last in an initializer " +
            "list (see https://goo.gl/EY6hDP): '{0}'.");

        public static StrongModeCode NON_GROUND_TYPE_CHECK_INFO = new StrongModeCode(
              ErrorType.HINT,
            "NON_GROUND_TYPE_CHECK_INFO",
            "Runtime check on non-ground type '{0}' may throw StrongModeError.");

        public static StrongModeCode DYNAMIC_INVOKE = new StrongModeCode(
              ErrorType.HINT, "DYNAMIC_INVOKE", "'{0}' requires a dynamic invoke.");

        public static StrongModeCode INVALID_FIELD_OVERRIDE = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "INVALID_FIELD_OVERRIDE",
            "Field declaration '{3}.{1}' can't be overridden in '{0}'.");

        public static StrongModeCode IMPLICIT_DYNAMIC_PARAMETER = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_PARAMETER",
            "Missing parameter type for '{0}'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode IMPLICIT_DYNAMIC_RETURN = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_RETURN",
            "Missing return type for '{0}'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode IMPLICIT_DYNAMIC_VARIABLE = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_VARIABLE",
            "Missing variable type for '{0}'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode IMPLICIT_DYNAMIC_FIELD = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_FIELD",
            "Missing field type for '{0}'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode IMPLICIT_DYNAMIC_TYPE = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_TYPE",
            "Missing type arguments for generic type '{0}'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode IMPLICIT_DYNAMIC_LIST_LITERAL =
              new StrongModeCode(
                  ErrorType.COMPILE_TIME_ERROR,
        ...
        public static StrongModeCode IMPLICIT_DYNAMIC_MAP_LITERAL =
              new StrongModeCode(
                  ErrorType.COMPILE_TIME_ERROR,
        ...
        public static StrongModeCode IMPLICIT_DYNAMIC_FUNCTION = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_FUNCTION",
            "Missing type arguments for generic function '{0}<{1}>'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode IMPLICIT_DYNAMIC_METHOD = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_METHOD",
            "Missing type arguments for generic method '{0}<{1}>'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode IMPLICIT_DYNAMIC_INVOKE = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "IMPLICIT_DYNAMIC_INVOKE",
            "Missing type arguments for calling generic function type '{0}'.",
            correction: _implicitDynamicCorrection);

        public static StrongModeCode NO_DEFAULT_BOUNDS = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "NO_DEFAULT_BOUNDS",
            "Type has no default bounds",
            correction: "Try adding explicit type arguments to type");

        public static StrongModeCode NOT_INSTANTIATED_BOUND = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
         ...
         */
        public static StrongModeCode TOP_LEVEL_CYCLE = new StrongModeCode(
              ErrorType.COMPILE_TIME_ERROR,
            "TOP_LEVEL_CYCLE",
        ...
        public static StrongModeCode TOP_LEVEL_FUNCTION_LITERAL_BLOCK =
              new StrongModeCode(ErrorType.HINT, "TOP_LEVEL_FUNCTION_LITERAL_BLOCK",
        ...
        public static StrongModeCode TOP_LEVEL_IDENTIFIER_NO_TYPE = new StrongModeCode(
              ErrorType.HINT,
        ...
        public static StrongModeCode TOP_LEVEL_INSTANCE_GETTER = new StrongModeCode(
        ...
        public static StrongModeCode TOP_LEVEL_INSTANCE_METHOD = new StrongModeCode(
              ErrorType.STATIC_WARNING,
        ...
        public static StrongModeCode TOP_LEVEL_UNSUPPORTED = new StrongModeCode(
              ErrorType.HINT,
         ...
         */
        public StrongModeCode(ErrorType type, String name, String message,
              String correction = "")
              : base("STRONG_MODE_$name", message, correction: correction)
        {
            this.type = type;
        }
