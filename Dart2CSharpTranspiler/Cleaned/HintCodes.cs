...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     */
    public class HintCode : ErrorCode
    {
        /**
         ...
         */
        public static HintCode ARGUMENT_TYPE_NOT_ASSIGNABLE = new HintCode(
         ...
         */
        public static HintCode CAN_BE_NULL_AFTER_NULL_AWARE = new HintCode(
         ...
         */
        public static HintCode DEAD_CODE = new HintCode("DEAD_CODE", "Dead code.",
         ...
         */
        public static HintCode DEAD_CODE_CATCH_FOLLOWING_CATCH = new HintCode(
         ...
         */
        public static HintCode DEAD_CODE_ON_CATCH_SUBTYPE = new HintCode(
         ...
         */
        public static HintCode DEPRECATED_MEMBER_USE = new HintCode(
         ...
         */
        public static HintCode DEPRECATED_FUNCTION_CLASS_DECLARATION = new HintCode(
         ...
         */
        public static HintCode DEPRECATED_EXTENDS_FUNCTION = new HintCode(
         ...
         */
        public static HintCode DEPRECATED_MIXIN_FUNCTION = new HintCode(
         ...
         */
        public static HintCode DIVISION_OPTIMIZATION = new HintCode(
         ...
         * Duplicate imports.
         */
        public static HintCode DUPLICATE_IMPORT = new HintCode(
         ...
         */
        public static HintCode DUPLICATE_HIDDEN_NAME =
          new HintCode("DUPLICATE_HIDDEN_NAME", "Duplicate hidden name.",
         ...
         */
        public static HintCode DUPLICATE_SHOWN_NAME =
          new HintCode("DUPLICATE_SHOWN_NAME", "Duplicate shown name.",
         ...
         * directory.
         */
        public static HintCode FILE_IMPORT_INSIDE_LIB_REFERENCES_FILE_OUTSIDE =
          new HintCode(
         ...
         * directory.
         */
        public static HintCode FILE_IMPORT_OUTSIDE_LIB_REFERENCES_FILE_INSIDE =
          new HintCode(
         ...
         */
        public static HintCode GENERIC_METHOD_COMMENT = new HintCode(
         ...
         */
        public static HintCode IMPORT_DEFERRED_LIBRARY_WITH_LOAD_FUNCTION =
          new HintCode(
         ...
         */
        public static HintCode INVALID_ASSIGNMENT = new HintCode(
          "INVALID_ASSIGNMENT",
         ...
         */
        public static HintCode INVALID_FACTORY_ANNOTATION = new HintCode(
         ...
         */
        public static HintCode INVALID_FACTORY_METHOD_DECL = new HintCode(
         ...
         */
        public static HintCode INVALID_FACTORY_METHOD_IMPL = new HintCode(
         ...
         */
        public static HintCode INVALID_IMMUTABLE_ANNOTATION = new HintCode(
         ...
         */
        public static HintCode INVALID_METHOD_OVERRIDE_TYPE_PARAMETERS =
          new HintCode(
         ...
         */
        public static HintCode INVALID_METHOD_OVERRIDE_TYPE_PARAMETER_BOUND =
          new HintCode(
         ...
         * 0: the name of the member
         */
        public static HintCode INVALID_REQUIRED_PARAM = new HintCode(
         ...
         * 0: the name of the member
         */
        public static HintCode INVALID_SEALED_ANNOTATION = new HintCode(
         ...
         */
        public static HintCode INVALID_USE_OF_PROTECTED_MEMBER = new HintCode(
        ...
        /// 0: the name of the member
        /// 1: the name of the defining class
        public static HintCode INVALID_USE_OF_VISIBLE_FOR_TEMPLATE_MEMBER =
          new HintCode("INVALID_USE_OF_VISIBLE_FOR_TEMPLATE_MEMBER",
        ...
        /// 0: the name of the member
        /// 1: the name of the defining class
        public static HintCode INVALID_USE_OF_VISIBLE_FOR_TESTING_MEMBER =
          new HintCode("INVALID_USE_OF_VISIBLE_FOR_TESTING_MEMBER",
          "The member '{0}' can only be used within '{1}' or a test.");

        /**
         * Hint for the `x is double` type checks.
         */
        public static HintCode IS_DOUBLE = new HintCode(
          "IS_DOUBLE",
         ...
         */
        public static HintCode IS_INT = new HintCode(
          "IS_INT",
            "When compiled to JS, this test might return true when the left hand " +
            "side is a double.",
            correction: "Try testing for 'num' instead.");
         ...
         * Hint for the `x is! double` type checks.
         */
        public static HintCode IS_NOT_DOUBLE = new HintCode(
          "IS_NOT_DOUBLE",
         ...
         * Hint for the `x is! int` type checks.
         */
        public static HintCode IS_NOT_INT = new HintCode(
          "IS_NOT_INT",
            "When compiled to JS, this test might return false when the left hand " +
            "side is a double.",
            correction: "Try testing for 'num' instead.");
         ...
         */
        public static HintCode MISSING_JS_LIB_ANNOTATION = new HintCode(
         ...
         */
        public static HintCode MISSING_REQUIRED_PARAM = new HintCode(
         ...
         * 1: message details
         */
        public static HintCode MISSING_REQUIRED_PARAM_WITH_DETAILS = new HintCode(
         ...
         */
        public static HintCode MISSING_RETURN = new HintCode(
          "MISSING_RETURN",
         ...
         */
        public static HintCode MUST_BE_IMMUTABLE = new HintCode(
          "MUST_BE_IMMUTABLE",
         ...
         */
        public static HintCode MUST_CALL_SUPER = new HintCode(
          "MUST_CALL_SUPER",
         ...
         * `null`.
         */
        public static HintCode NULL_AWARE_BEFORE_OPERATOR = new HintCode(
         ...
         */
        public static HintCode NULL_AWARE_IN_CONDITION = new HintCode(
         ...
         */
        public static HintCode NULL_AWARE_IN_LOGICAL_OPERATOR = new HintCode(
         ...
         */
        public static HintCode OVERRIDE_EQUALS_BUT_NOT_HASH_CODE = new HintCode(
         ...
         */
        public static HintCode OVERRIDE_ON_NON_OVERRIDING_GETTER = new HintCode(
         ...
         */
        public static HintCode OVERRIDE_ON_NON_OVERRIDING_FIELD = new HintCode(
         ...
         */
        public static HintCode OVERRIDE_ON_NON_OVERRIDING_METHOD = new HintCode(
         ...
         */
        public static HintCode OVERRIDE_ON_NON_OVERRIDING_SETTER = new HintCode(
         ...
         */
        public static HintCode PACKAGE_IMPORT_CONTAINS_DOT_DOT = new HintCode(
         ...
         */
        public static HintCode TYPE_CHECK_IS_NOT_NULL = new HintCode(
         ...
         * Type checks of the type `x is Null` should be done with `x == null`.
         */
        public static HintCode TYPE_CHECK_IS_NULL = new HintCode(
         ...
         */
        public static HintCode UNDEFINED_GETTER = new HintCode(
         ...
         */
        public static HintCode UNDEFINED_HIDDEN_NAME = new HintCode(
         ...
         */
        public static HintCode UNDEFINED_METHOD = new HintCode(
         ...
         */
        public static HintCode UNDEFINED_OPERATOR = new HintCode(
          "UNDEFINED_OPERATOR",
         ...
         */
        public static HintCode UNDEFINED_SETTER = new HintCode(
         ...
         */
        public static HintCode UNDEFINED_SHOWN_NAME = new HintCode(
         ...
         * Unnecessary cast.
         */
        public static HintCode UNNECESSARY_CAST = new HintCode(
         ...
         */
        public static HintCode UNNECESSARY_NO_SUCH_METHOD = new HintCode(
         ...
         */
        public static HintCode UNNECESSARY_TYPE_CHECK_FALSE = new HintCode(
         ...
         */
        public static HintCode UNNECESSARY_TYPE_CHECK_TRUE = new HintCode(
         ...
         */
        public static HintCode UNUSED_CATCH_CLAUSE = new HintCode(
          "UNUSED_CATCH_CLAUSE",
         ...
         */
        public static HintCode UNUSED_CATCH_STACK = new HintCode(
          "UNUSED_CATCH_STACK",
         ...
         */
        public static HintCode UNUSED_ELEMENT = new HintCode(
         ...
         */
        public static HintCode UNUSED_FIELD = new HintCode(
         ...
         */
        public static HintCode UNUSED_IMPORT = new HintCode(
         ...
         * 'continue' statement.
         */
        public static HintCode UNUSED_LABEL =
          new HintCode("UNUSED_LABEL", "The label '{0}' isn't used.",
         ...
         */
        public static HintCode UNUSED_LOCAL_VARIABLE = new HintCode(
         ...
         */
        public static HintCode UNUSED_SHOWN_NAME = new HintCode(
         ...
         */
        public static HintCode WRONG_NUMBER_OF_TYPE_ARGUMENTS_METHOD = new HintCode(
         ...
         */
        public HintCode(String name, String message, String correction = "")
            : base(name, message, correction: correction)
        {

        }

        public ErrorSeverity errorSeverity => ErrorType.HINT.severity;


        public ErrorType type => ErrorType.HINT;
    }
}
