...
namespace Dart2CSharpTranspiler.Parser
{
    ...
    public class Error
    {
        public static List<ErrorCode> errorCodeValues = new List<ErrorCode> { 
      //
      ...
      TodoCode.TODO
         ...
         * instance.
         */
        public Dictionary<String, ErrorCode> _uniqueNameToCodeMap;

        /**
         * Return the [ErrorCode] with the given [uniqueName], or `null` if not
         * found.
         */
        public ErrorCode errorCodeByUniqueName(String uniqueName)
        {
            if (_uniqueNameToCodeMap == null)
            {
                _uniqueNameToCodeMap = new Dictionary<String, ErrorCode>();
                foreach (ErrorCode errorCode in errorCodeValues)
                {
    ...
    public class AnalysisError
    {
         ...
         */
        public static List<AnalysisError> NO_ERRORS = new List<AnalysisError> { };

        /**
         * A [Comparator] that sorts by the name of the file that the [AnalysisError]
         * was found.
         */
        //  public static Comparator<AnalysisError> FILE_COMPARATOR =
         ...
         */
        public bool isStaticOnly = false;
         ...
         */
        public String correction => _correction;


        public virtual int hashCode()
        {
            int hashCode = offset;
            hashCode ^= (_message != null) ? _message.GetHashCode() : 0;
        ...
        public static bool operator !=(AnalysisError other, AnalysisError other2) => !(other == other2);

        public static bool operator ==(AnalysisError other, AnalysisError other2)
        {
            if (identical(other, other2))
            {
                return true;
            }
            ...
            {
                // Quick checks.
                if (!identical(other2.errorCode, other.errorCode))
                {
                    return false;
                }
                if (other2.offset != other.offset || other2.length != other.length)
                {
                    return false;
                }
                if (other2.isStaticOnly != other.isStaticOnly)
                {
                    return false;
                }
                // Deep checks.
                if (other2._message != other._message)
                {
                    return false;
                }
                if (other2.source != other.source)
                {
                    return false;
                }
                // OK
