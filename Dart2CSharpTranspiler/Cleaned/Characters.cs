namespace Dart2CSharpTranspiler.Parser
{
    public class Characters
    {
        ...
        public bool isHexDigit(int characterCode)
        {
        ...
        public int hexDigitValue(int hexDigit)
        {
        ...
        public bool isUnicodeScalarValue(int value)
        {
            return value < _FIRST_SURROGATE ||
                (value > _LAST_SURROGATE && value <= _LAST_CODE_POINT);
        }

        public bool isUtf16LeadSurrogate(int value)
        {
            return value >= 0xd800 && value <= 0xdbff;
        }

        public bool isUtf16TrailSurrogate(int value)
        {
