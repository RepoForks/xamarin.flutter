...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/src/generated/utilities_dart.dart
...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     */
    public class ParameterKind : Comparable<ParameterKind>
    {
        public static ParameterKind REQUIRED =
            new ParameterKind("REQUIRED", 0, false);

        public static ParameterKind POSITIONAL =
      new ParameterKind("POSITIONAL", 1, true);

        public static ParameterKind NAMED = new ParameterKind("NAMED", 2, true);

        public static List<ParameterKind> values = new List<ParameterKind> { REQUIRED, POSITIONAL, NAMED };
         ...
         */
        public ParameterKind(String name, int ordinal, bool isOptional)
        {
            this.name = name;
        ...
        public int compareTo(ParameterKind other) => ordinal - other.ordinal;
