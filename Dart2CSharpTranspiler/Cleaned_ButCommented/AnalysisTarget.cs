...
namespace Dart2CSharpTranspiler.Parser
{
     ...
     */
    //public delegate TaskInput<E> BinaryFunction<K, V, E>(K key, V value);
     ...
     */
    // public delegate AnalysisTask BuildTask(AnalysisContext context, AnalysisTarget target);
     ...
     */
    //public delegate Map<String, TaskInput> CreateTaskInputs(AnalysisTarget target);
     ...
     */
    //public delegate TaskSuitability SuitabilityFor(AnalysisTarget target);
     ...
     */
    //public delegate TaskInput<E> UnaryFunction<B, E>(B object);

    /**
     * An [AnalysisTarget] wrapper for an [AnalysisContext].
     */
    //  public class AnalysisContextTarget : AnalysisTarget
    //  {
     ...
     */
    //    abstract class ListResultDescriptor<E> : ResultDescriptor<List<E>>
    //    {
    //        /**
     ...
     * Clients may not extend, implement or mix-in this class.
     */
    //abstract class ListTaskInput<E> : TaskInput<List<E>>
    //{
    //    /**
     ...
     * Clients may not extend, implement or mix-in this class.
     */
    //abstract class MapTaskInput<K, V> : TaskInput<Dictionary<K, V>>
    //{
    //    /**
    //     * [V] must be a [List].
    //     * Return a task input that can be used to compute a list whose elements are
    ...
    //     */
    //    [Obsolete]
    //    public static List<TargetedResult> EMPTY_LIST = new List<TargetedResult> { };

    //    /**
    //     * The target with which the result is associated.
    //     */
    //    public readonly AnalysisTarget target;

    //    /**
    //     * The result associated with the target.
    //     */
    //    public readonly ResultDescriptor result;
    ...
    //    public int hashCode => JenkinsSmiHash.combine(target.hashCode, result.hashCode);
     ...
     * Clients may not extend, implement or mix-in this class.
     */
    //public abstract class TaskInput<V>
    //{
    //    /**
    //     * Create and return a builder that can be used to build this task input.
    //     */
    //    public abstract TaskInputBuilder<V> createBuilder();

    //    /**
    //     * Return a task input that can be used to compute a list whose elements are
    //     * the result of passing the result of this input to the [mapper] function.
    //     */
    //    public abstract ListTaskInput<E> mappedToList<E>(List<E> mapper(V value));
    //}
     ...
     * Clients may not extend, implement or mix-in this class.
     */
    //  public abstract class TaskInputBuilder<V>
    //  {
    //      /**
    ...
    //https://github.com/dart-lang/sdk/blob/master/pkg/front_end/lib/src/base/analysis_target.dart
    ...
    public abstract class AnalysisTarget
    {
         ...
         */
        public Source librarySource { get; }
