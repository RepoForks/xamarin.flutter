...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/src/generated/resolver.dart
...
namespace Dart2CSharpTranspiler.Parser
{
    ...
    /// `const` feature.
    //    public class AstRewriteVisitor : ScopedVisitor
    //    {
    //        readonly bool addConstKeyword;
    ...
    //    class BestPracticesVerifier : RecursiveAstVisitor<Object>
    //    {
    ...
    //        static readonly _templateExtension = '.template';

    //static readonly _testDir = '${path.separator}test${path.separator}';

    //static readonly _testingDir = '${path.separator}testing${path.separator}';
    ...
    //          }
    //        }
    //        foreach (InterfaceType mixin in element.interfaces) {
    ...
    //    /// Return `true` if the given class [element] defines a non-readonly instance
    //    /// field.
    ...
    //        readonly nonNamedParamsWithRequired =
    //            requiredParameters.where((p) => !p.isNamed);
    //        readonly namedParamsWithRequiredAndDefault = requiredParameters
    //            .where((p) => p.isNamed)
    //            .where((p) => p.declaredElement.defaultValueCode != null);
    //        readonly paramsToHint = [
    //          nonNamedParamsWithRequired,
    //          namedParamsWithRequiredAndDefault
    //        ].expand((e) => e);
    //        for (readonly param in paramsToHint)
    //    {
    //            _errorReporter.reportErrorForNode(
    ...
    /// [HintCode.IS_DOUBLE].
    //class Dart2JSVerifier : RecursiveAstVisitor<Object>
    //{
    ...
    //class DeadCodeVerifier : RecursiveAstVisitor<Object>
    //{
    //    /// The error reporter by which errors will be reported.
    //    readonly ErrorReporter _errorReporter;

    //    ///  The type system for this visitor
    //    readonly TypeSystem _typeSystem;
    ...
    //  /// are mandated by the language spec. This allows for a readonly break,
    ...
    //class DirectiveResolver : SimpleAstVisitor
    //{
    //    readonly Map<Source, int> sourceModificationTimeMap;
    //    readonly Map<Source, SourceKind> importSourceKindMap;
    //    readonly Map<Source, SourceKind> exportSourceKindMap;
    //    readonly List<AnalysisError> errors = < AnalysisError >[];
    ...
    //        public abstract List<PropertyAccessorElement> accessors {
    //    if (_accessors == null) {
    ...
    /// declarations.
    //class EnumMemberBuilder : RecursiveAstVisitor<Object>
    //{
    ...
    /// `while(true)`.
    //class ExitDetector : GeneralizingAstVisitor<bool>
    //{
    ...
    //class GatherUsedImportedElementsVisitor : RecursiveAstVisitor
    //{
    //    readonly LibraryElement library;
    //    readonly UsedImportedElements usedElements = new UsedImportedElements();
    ...
    //class GatherUsedLocalElementsVisitor : RecursiveAstVisitor
    //{
    //    readonly UsedLocalElements usedElements = new UsedLocalElements();

    //    readonly LibraryElement _enclosingLibrary;
    ...
    //        readonly List<ImportDirective> _allImports = < ImportDirective >[];
    ...
    //        readonly List<ImportDirective> _unusedImports = < ImportDirective >[];
    ...
    //        readonly List<ImportDirective> _duplicateImports = < ImportDirective >[];

    //        /// The cache of [Namespace]s for [ImportDirective]s.
    //        readonly HashMap<ImportDirective, Namespace> _namespaceMap =
    ...
    //        /// directive is used.
    //        readonly HashMap<PrefixElement, List<ImportDirective>> _prefixElementMap =
    ...
    //        readonly HashMap<ImportDirective, List<SimpleIdentifier>> _unusedShownNamesMap =
    //            new HashMap<ImportDirective, List<SimpleIdentifier>>();

    //        /// A map of names that are hidden more than once.
    //        readonly HashMap<NamespaceDirective, List<SimpleIdentifier>>
    ...
    //        {
    //    foreach (Directive directive in node.directives)
    //            {
    ...
    //      readonly List<DartType> _inferredReturn = < DartType >[];

    //      /// A stack of return types for all of the enclosing
    //      /// functions and methods.
    //      readonly List<DartType> _returnStack = < DartType >[];
    ...
    /// initializers list.
    //    class INIT_STATE : Comparable<INIT_STATE> {
    ...
    //class InstanceFieldResolverVisitor : ResolverVisitor
    //{
    ...
    //class OverrideVerifier : RecursiveAstVisitor
    //{
    //    /// The error reporter used to report errors.
    //    readonly ErrorReporter _errorReporter;

    //    /// The inheritance manager used to find overridden methods.
    //    readonly InheritanceManager _manager;
    ...
    /// function bodies.
    //class PartialResolverVisitor : ResolverVisitor
    //{
    ...
    //    /// be inferred.
    //    readonly List<VariableElement> staticVariables = < VariableElement >[];
    ...
    //    class RedirectingConstructorKind: Comparable<RedirectingConstructorKind> {
    ...
    //class ResolverVisitor : ScopedVisitor
    //{
    //    /**
    //     * The manager for the inheritance mappings.
    //     */
    //    readonly InheritanceManager2 inheritance;
    ...
    //        // have to clone the initializers for non-static readonly fields (because if
    ...
    //abstract class ScopedVisitor : UnifyingAstVisitor<Object>
    //{
    //    /// The element for the library containing the compilation unit being visited.
    //    readonly LibraryElement definingLibrary;
    ...
    //  {
    //      readonly TypeSystem typeSystem;
    //      readonly DartType dynamicType;
    //      readonly DartType undefinedType;
    //      readonly LibraryElement definingLibrary;
    //      readonly Source source;
    //      readonly AnalysisErrorListener errorListener;
    ...
    //      /// task model.
    //      readonly bool shouldUseWithClauseInferredTypes;
    ...
    //    readonly TypeOverrideManager_TypeOverrideScope _outerScope;
    ...
    //    readonly TypePromotionManager_TypePromoteScope _outerScope;
    ...
    public abstract class TypeProvider
    {
        ...
        public abstract InterfaceType boolType { get; }

        /// Return the type representing the type 'bottom'.
        public abstract DartType bottomType { get; }

        /// Return the type representing the built-in type 'Deprecated'.
        public abstract InterfaceType deprecatedType { get; }

        /// Return the type representing the built-in type 'double'.
        public abstract InterfaceType doubleType { get; }

        /// Return the type representing the built-in type 'dynamic'.
        public abstract DartType dynamicType { get; }

        /// Return the type representing the built-in type 'Function'.
        public abstract InterfaceType functionType { get; }

        /// Return the type representing 'Future<dynamic>'.
        public abstract InterfaceType futureDynamicType { get; }

        /// Return the type representing 'Future<Null>'.
        public abstract InterfaceType futureNullType { get; }

        /// Return the type representing 'FutureOr<Null>'.
        public abstract InterfaceType futureOrNullType { get; }

        /// Return the type representing the built-in type 'FutureOr'.
        public abstract InterfaceType futureOrType { get; }

        /// Return the type representing the built-in type 'Future'.
        public abstract InterfaceType futureType { get; }

        /// Return the type representing the built-in type 'int'.
        public abstract InterfaceType intType { get; }

        /// Return the type representing the type 'Iterable<dynamic>'.
        public abstract InterfaceType iterableDynamicType { get; }

        /// Return the type representing the built-in type 'Iterable'.
        public abstract InterfaceType iterableType { get; }

        /// Return the type representing the built-in type 'List'.
        public abstract InterfaceType listType { get; }

        /// Return the type representing the built-in type 'Map'.
        public abstract InterfaceType mapType { get; }

        /// Return a list containing all of the types that cannot be either extended
        /// or implemented.
        public abstract List<InterfaceType> nonSubtypableTypes { get; }

        /// Return a [DartObjectImpl] representing the `null` object.
        //public abstract DartObjectImpl nullObject { get; } //TODO:

        /// Return the type representing the built-in type 'Null'.
        public abstract InterfaceType nullType { get; }

        /// Return the type representing the built-in type 'num'.
        public abstract InterfaceType numType { get; }

        /// Return the type representing the built-in type 'Object'.
        public abstract InterfaceType objectType { get; }

        /// Return the type representing the built-in type 'StackTrace'.
        public abstract InterfaceType stackTraceType { get; }

        /// Return the type representing 'Stream<dynamic>'.
        public abstract InterfaceType streamDynamicType { get; }

        /// Return the type representing the built-in type 'Stream'.
        public abstract InterfaceType streamType { get; }

        /// Return the type representing the built-in type 'String'.
        public abstract InterfaceType stringType { get; }

        /// Return the type representing the built-in type 'Symbol'.
        public abstract InterfaceType symbolType { get; }

        /// Return the type representing the built-in type 'Type'.
        public abstract InterfaceType typeType { get; }

        /// Return the type representing typenames that can't be resolved.
        public abstract DartType undefinedType { get; }

        /// Return 'true' if [id] is the name of a getter on
        /// the Object type.
        public abstract bool isObjectGetter(String id);

        /// Return 'true' if [id] is the name of a method or getter on
        /// the Object type.
        public abstract bool isObjectMember(String id);

        /// Return 'true' if [id] is the name of a method on
        /// the Object type.
        public abstract bool isObjectMethod(String id);
    }

    /// Provide common functionality shared by the various TypeProvider
    /// implementations.
    //abstract class TypeProviderBase : TypeProvider
    //{
    ...
    /// library.
    //    class TypeProviderImpl : TypeProviderBase
    //    {
    ...
    //class TypeResolverVisitor : ScopedVisitor
    //{
    ...
    //    readonly bool _strongMode = true;
    ...
    //    readonly TypeResolverMode mode;
    ...
    //    /// new driver.
    //    readonly bool shouldSetElementSupertypes;
    ...
    //class UnusedLocalElementsVerifier : RecursiveAstVisitor
    //{
    //    /// The error listener to which errors will be reported.
    //    readonly AnalysisErrorListener _errorListener;

    //    /// The elements know to be used.
    //    readonly UsedLocalElements _usedElements;
    ...
    //    /// prefix.
    //    readonly Map<PrefixElement, List<Element>> prefixMap =
    //        new HashMap<PrefixElement, List<Element>>();

    //    /// The set of referenced top-level [Element]s.
    //    readonly Set<Element> elements = new HashSet<Element>();
    //}
    ...
    //    /// used.
    //    readonly HashSet<Element> elements = new HashSet<Element>();

    //    /// [LocalVariableElement]s that represent exceptions in [CatchClause]s.
    //    readonly HashSet<LocalVariableElement> catchExceptionElements =
    //        new HashSet<LocalVariableElement>();

    //    /// [LocalVariableElement]s that represent stack traces in [CatchClause]s.
    //    readonly HashSet<LocalVariableElement> catchStackTraceElements =
    //        new HashSet<LocalVariableElement>();
    ...
    //    /// library.
    //    readonly HashSet<String> readMembers = new HashSet<String>();
    ...
    //class VariableResolverVisitor : ScopedVisitor
    //{
    ...
    //    readonly _LabelTracker outerTracker;
    ...
    //    readonly Map<String, int> labelMap = < String, int>{ };
