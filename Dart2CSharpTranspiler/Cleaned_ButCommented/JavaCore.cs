...
//https://github.com/dart-lang/sdk/blob/master/pkg/analyzer/lib/src/generated/java_core.dart
...
namespace Dart2CSharpTranspiler.Parser
{
    public class JavaCore
    {
         ...
         *     format('{0} are you {1}ing?', ['What', 'read']) = 'What are you reading?'
         */
        public static String formatList(String pattern, List<Object> arguments)
        {
        ...
        //            }
        //            // unknown
        //            throw new ArgumentException("[$fmt][$i] = 0x${c.toRadixString(16)}");
        //        }
        //        else
        //        {
        //            sb.writeCharCode(c);
        ...
        public class Character
        {
            ...
            public static int digit(int codePoint, int radix)
            {
                if (radix != 16)
                {
                    throw new ArgumentException("only radix == 16 is supported");
                }
